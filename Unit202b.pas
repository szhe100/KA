...
begin
    ...
    begin
        ...
        begin
            commandtext:='select b.dtl_id,cate_id=isnull(a.cate_id,1),a.bod_type_id,a.bod_cd,a.bod_status_id,d.med_code,d.material_code,d.material_code1,d.med_name,d.specifi,d.pdt_place,d.qtyperpack,d.type_id1,j.mate_name,j.mate_type_id,';
            commandtext:=commandtext+' cdistrict=dbo.fn_getdistrict1(j.district),b.bod_cd2,b.terminal_id,';
...
//                if Trim(dxLookupTreeView1.text)<>'' then commandtext:=commandtext+' and dbo.fn_treeischild(j.district,'+dm.district.fieldbyname('rec_id').asstring+')>0 '
        ...
        begin
            ...
            commandtext:=commandtext+' select b.dtl_id,cate_id=isnull(a.cate_id,1),a.bod_type_id,a.bod_cd,a.bod_status_id,d.med_code,d.material_code,d.material_code1,d.med_name,d.specifi,d.pdt_place,d.qtyperpack,d.type_id1,j.mate_name,j.mate_type_id,';
//            commandtext:=commandtext+' a.platform_id,cate_id1=0,'; //dbo.fn_getmatemedcateid(a.comp_id,a.src_id,b.med_id),';
            commandtext:=commandtext+' cdistrict='''',b.bod_cd2,b.terminal_id,a.channel_id,channel=dbo.fn_obj_desc(a.channel_id),a.channel_dtl_id,channel_dtl=dbo.fn_obj_desc(a.channel_dtl_id),';
...
//                if Trim(dxLookupTreeView1.text)<>'' then commandtext:=commandtext+' and dbo.fn_treeischild(a.district_id,'+dm.district.fieldbyname('rec_id').asstring+')>0 '
    ...
    //        if fdistltd then commandtext:=commandtext+' and exists (select 1 from tb_trustdistrict t where t.sta_id='+inttostr(curuserid)+' and dbo.fn_ischildnode(e.district,t.dist_id)=1)';  //依据业务负责人地区 以限制地区
            ...
            commandtext:=commandtext+' m.qtyperpack,type_id1=0,mate_name=a.NAME1,c.mate_type_id,cdistrict=dbo.fn_getdistrict1(c.district),bod_cd='''',terminal_id='''',';
            ...
            commandtext:=commandtext+' left join (select mate_code,mate_name,district,mate_type_id from tb_busimate where mate_type_id=2) c on a.NAME1=c.mate_name';
