...
uses
  ...
  GIFCtrl, DBClient, ADODB, Comobj, mycds, Menus;
...
procedure Tsetexpaybook.N4Click(Sender: TObject);
...
procedure Tsetexpaybook.N3Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t : string;
begin
if (bill.active=false) or (bill.recordcount=0) then exit;
...
procedure Tsetexpaybook.N2Click(Sender: TObject);
begin
