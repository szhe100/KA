...
begin
    ...
    begin
        ...
        fieldbyname('bod_cd').asstring:=formatfloat('00000000',getbillid(compid,58));
    end;
...
begin
    ...
    commandtext:=commandtext+' f.bank_name,broker=g.zname,carry_dt1=dbo.fn_getcarrydt(a.bod_id),'; //j.carry_dt, h.carry_dt2,';
...
begin
    ...
    begin
        s:='本单业务负责人('+fieldbyname('mate_name').asstring+')已暂停收款，请与财务确认'+#13+#10+'------------------------------------------------';
