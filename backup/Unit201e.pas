...
begin
    ...
    commandtext:='select dtl_id,a.bod_type_id,a.bod_cd,e.med_code,e.material_code,e.material_code1,e.med_name,e.specifi,a.src_id,mate_name1=g.mate_name,a.dst_id,c.mate_name,cdistrict=dbo.fn_getdistrict(c.district),a.agent_id,agent=d.mate_name,'; //dbo.fn_mate_name(a.agent_id),';
    ...
    if Trim(dxEdit2.text)<>'' then commandtext:=commandtext+' and e.material_code like '''+Trim(dxEdit2.text)+'%''';
