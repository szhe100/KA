...
type
  Tsetbrokeraccount2 = class(TForm)
...
var
  setbrokeraccount2: Tsetbrokeraccount2;
...
procedure Tsetbrokeraccount2.setupdatestatus;    // 编辑状态
begin
speedbutton2.enabled:=false;    // examine disable
speedbutton5.enabled:=false;   // refresh disable
end;

procedure Tsetbrokeraccount2.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetbrokeraccount2.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetbrokeraccount2.FormCloseQuery(Sender: TObject;
...
procedure Tsetbrokeraccount2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetbrokeraccount2.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbrokeraccount2.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetbrokeraccount2.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetbrokeraccount2.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetbrokeraccount2.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=27 and a.bod_status_id in (1,3,4)';  // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetbrokeraccount2.FormCreate(Sender: TObject);
begin
N2.Visible:=False;
...
procedure Tsetbrokeraccount2.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetbrokeraccount2.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetbrokeraccount2.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokeraccount2.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokeraccount2.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetbrokeraccount2.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetbrokeraccount2.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetbrokeraccount2.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetbrokeraccount2.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetbrokeraccount2.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetbrokeraccount2.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetbrokeraccount2.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetbrokeraccount2.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbrokeraccount2.dxDBGrid1CustomDrawCell(Sender: TObject;
...
begin
    if (ANode.Values[dxdbgrid1cbod_status.Index] ='财务复核') then Acolor := $00A3FEFC;
...
procedure Tsetbrokeraccount2.N1Click(Sender: TObject);
...
procedure Tsetbrokeraccount2.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetbrokeraccount2.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetbrokeraccount2.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
...
procedure Tsetbrokeraccount2.SpeedButton6Click(Sender: TObject);
begin
