...
//                if Trim(dxLookupTreeView1.text)<>'' then commandtext:=commandtext+' and dbo.fn_treeischild(a.district_id,'+dm.district.fieldbyname('rec_id').asstring+')>0 '
    ...
    //        if fdistltd then commandtext:=commandtext+' and exists (select 1 from tb_trustdistrict t where t.sta_id='+inttostr(curuserid)+' and dbo.fn_ischildnode(e.district,t.dist_id)=1)';  //依据业务负责人地区 以限制地区
            ...
            commandtext:=commandtext+' channel_id=VTWEG,channel=VTEXT,channel_dtl_id=KDGRP,channel_dtl=ZKDGRP, dist1=dbo.fn_getdistrictlevel (c.district,1), dist2=dbo.fn_getdistrictlevel (c.district,2),';
            ...
            commandtext:=commandtext+' price=cast(a.price as decimal(15,6)),a.qty,discount=0.0000,valid_dt=cast(VFDAT as datetime),amot=cast(a.price*a.qty as decimal(18,2)), price2=cast(a.ZPR03 as decimal(15,6)),';
            ...
            commandtext:=commandtext+' from vi_ZSD_015 a';
