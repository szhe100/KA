object qryreport06: Tqryreport06
  Left = 180
  Top = 116
  AutoScroll = False
  Caption = #21307#38498#38144#21806#23545#27604#20998#26512#34920
  ClientHeight = 514
  ClientWidth = 1135
  Color = clBtnFace
  ...
  object Label6: TLabel
    ...
    Width = 48
    Height = 12
    Caption = #25130#27490#26376#20221
    Transparent = True
  end
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1level2: TdxDBGridMaskColumn
      Alignment = taCenter
      Width = 57
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1med_name: TdxDBGridColumn
      Caption = #26631#20934#21697#21517
      DisableEditor = True
      Font.Charset = GB2312_CHARSET
      Font.Color = clNavy
      Font.Height = -12
    ...
    object dxDBGrid1specifi: TdxDBGridColumn
      Caption = #26631#20934#35268#26684
      DisableEditor = True
      Width = 70
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1pdt_place: TdxDBGridColumn
      Caption = #26631#20934#20135#22320
      DisableEditor = True
      Width = 70
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1fnew: TdxDBGridCheckColumn
      DisableEditor = True
      MinWidth = 20
      Width = 78
      BandIndex = 0
    ...
    object dxDBGrid1Cf2: TdxDBGridCheckColumn
      DisableEditor = True
      Width = 72
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1Cf3: TdxDBGridCheckColumn
      DisableEditor = True
      Width = 72
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1amt10: TdxDBGridColumn
      DisableEditor = True
      Width = 70
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1amt11: TdxDBGridColumn
      DisableEditor = True
      Width = 70
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1amt12: TdxDBGridColumn
      DisableEditor = True
      Width = 70
      BandIndex = 0
      RowIndex = 0
  ...
  object dxCheckEdit1: TdxCheckEdit
    ...
    TabOrder = 10
    Anchors = [akTop, akRight]
    Caption = #26412#26376#26032#22686#21307#38498
  end
  object dxCheckEdit3: TdxCheckEdit
    ...
    TabOrder = 11
    Anchors = [akTop, akRight]
    Caption = '2'#20010#26376#26410#37319#36141
  ...
  object dxCheckEdit2: TdxCheckEdit
    ...
    TabOrder = 12
    Anchors = [akTop, akRight]
    Caption = #26412#26376#26410#37319#36141
  ...
  object dxCheckEdit4: TdxCheckEdit
    ...
    TabOrder = 13
    Anchors = [akTop, akRight]
    Caption = '3'#20010#26376#26410#37319#36141
  ...
  object qry: TClientDataSet
    ...
    Left = 103
    Top = 167
    object qrymate_id: TAutoIncField
      FieldName = 'mate_id'
      ReadOnly = True
    end
    ...
    object qrybusi_type: TStringField
      DisplayLabel = #21307#38498#31561#32423
      FieldName = 'busi_type'
      ReadOnly = True
      Size = 10
    end
    ...
    object qrydistrict: TIntegerField
      FieldName = 'district'
    end
    ...
    object qrysta_id: TIntegerField
      FieldName = 'sta_id'
    end
    ...
    object qryamt9: TBCDField
      DisplayLabel = '9'#26376#20221
      FieldName = 'amt9'
      ReadOnly = True
      DisplayFormat = '###,###,##0;; '
      Precision = 32
    end
    object qryamt10: TBCDField
      DisplayLabel = '10'#26376#20221
      FieldName = 'amt10'
      ReadOnly = True
      DisplayFormat = '###,###,##0;; '
      Precision = 32
    end
    object qryamt11: TBCDField
      DisplayLabel = '11'#26376#20221
      FieldName = 'amt11'
      ReadOnly = True
      DisplayFormat = '###,###,##0;; '
      Precision = 32
    end
    object qryamt12: TBCDField
      DisplayLabel = '12'#26376#20221
      FieldName = 'amt12'
      ReadOnly = True
      DisplayFormat = '###,###,##0;; '
      Precision = 32
    end
    object qryfnew: TBooleanField
      DisplayLabel = #26412#26376#26032#22686#21307#38498
      FieldName = 'fnew'
      ReadOnly = True
    end
    ...
    object qryCqty1: TFloatField
      DisplayLabel = #23436#25104#25351#26631
      FieldKind = fkCalculated
      FieldName = 'Cqty1'
      DisplayFormat = '###,###,##0;; '
      Calculated = True
    ...
    object qryCf1: TBooleanField
      DisplayLabel = #26412#26376#26410#37319#36141
      FieldKind = fkCalculated
      FieldName = 'Cf1'
      Calculated = True
    end
    object qryCf2: TBooleanField
      DisplayLabel = '2'#20010#26376#26410#37319#36141
      FieldKind = fkCalculated
      FieldName = 'Cf2'
      Calculated = True
    end
    object qryCf3: TBooleanField
      DisplayLabel = '3'#20010#26376#26410#37319#36141
      FieldKind = fkCalculated
      FieldName = 'Cf3'
      Calculated = True
    end
  ...
  object ADOQuery1: TADOQuery
    ConnectionString = 
      ...
      'al Catalog=KingageYPH'
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select fnew=cast(1 as bit)')
    Left = 31
    Top = 155
    object ADOQuery1fnew: TBooleanField
      FieldName = 'fnew'
      ReadOnly = True
    end
  end
