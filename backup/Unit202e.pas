...
procedure Tqryclassexp6.FormCloseQuery(Sender: TObject;
...
procedure Tqryclassexp6.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryclassexp6.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryclassexp6.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
...
procedure Tqryclassexp6.FormCreate(Sender: TObject);
begin
...
procedure Tqryclassexp6.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid2.SaveToXLS, self.tag)
end;

procedure Tqryclassexp6.SpeedButton5Click(Sender: TObject);
var si: integer;
begin
...
begin
    ...
    commandtext:=commandtext+' leader=dbo.fn_staff_name(b.lead_id),broker=dbo.fn_mate_name(a.agent_id),';
//    commandtext:=commandtext+' leader=dbo.fn_staff_name(dbo.fn_getleadid (b.sta_id,a.dst_id,b.med_id)),';
    ...
    commandtext:=commandtext+' left join tb_busiframe1 k on b.med_id=k.med_id and dbo.fn_ischildnode(j.district,k.district_id)=1'; //b.lead_id=k.sta_id and 
    commandtext:=commandtext+' where a.bod_type_id=2 and a.cate_id=3';  // and a.bod_status_id=1 a.comp_id='+inttostr(compid)+' and  and a.cate_id=2
...
procedure Tqryclassexp6.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassexp6.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassexp6.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tqryclassexp6.dxEdit1Click(Sender: TObject);
begin
dxEdit1.selectall;
dxEdit1.setfocus;
end;

procedure Tqryclassexp6.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassexp6.FormActivate(Sender: TObject);
begin
with level1 do
begin
...
procedure Tqryclassexp6.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
begin
...
procedure Tqryclassexp6.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tqryclassexp6.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tqryclassexp6.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tqryclassexp6.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tqryclassexp6.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tqryclassexp6.dxDBGrid1CustomDrawFooter(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
...
procedure Tqryclassexp6.qryCalcFields(DataSet: TDataSet);
begin
with qry do
begin
...
procedure Tqryclassexp6.SpeedButton3Click(Sender: TObject);
var Guid:TGUID;
    st,ss,sm: string;
begin
...
procedure Tqryclassexp6.SpeedButton1Click(Sender: TObject);
var Guid:TGUID;
    st,ss,sm,sr: string;
begin
with dm.pubqry do
...
procedure Tqryclassexp6.SpeedButton4Click(Sender: TObject);
var h: boolean;
begin
Timer1.Enabled:=True;
...
procedure Tqryclassexp6.Timer1Timer(Sender: TObject);
//var a,b:PAnsiChar;
var h:HWND;
begin
...
procedure Tqryclassexp6.dxLookupTreeView1KeyDown(Sender: TObject;
