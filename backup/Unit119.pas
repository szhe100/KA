...
procedure Tqryreport22.FormCloseQuery(Sender: TObject;
...
procedure Tqryreport22.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryreport22.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryreport22.DSdrawlogDataChange(Sender: TObject;
  Field: TField);
begin
speedbutton2.enabled:=(qry.active=true) and (qry.recordcount>0);
end;

procedure Tqryreport22.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tqryreport22.SpeedButton5Click(Sender: TObject);
var mi: integer;
begin
with qry do
begin
    ...
    commandtext:=commandtext+' a.broker_id,broker=dbo.fn_staff_name(a.broker_id),';
    ...
    commandtext:=commandtext+' where a.bod_type_id=27 and a.bod_status_id=1';
...
procedure Tqryreport22.FormCreate(Sender: TObject);
begin
dxdateedit1.date:=date;
dxdateedit2.date:=date;
end;

procedure Tqryreport22.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbroker do
