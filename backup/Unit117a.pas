...
var
  setmedexport8a: Tsetmedexport8a;
...
procedure Tsetmedexport8a.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetmedexport8a.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetmedexport8a.FormActivate(Sender: TObject);
begin
//with dm.imp_type do
...
procedure Tsetmedexport8a.FormCloseQuery(Sender: TObject;
...
procedure Tsetmedexport8a.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetmedexport8a.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetmedexport8a.dxDBGrid2Enter(Sender: TObject);
begin
...
procedure Tsetmedexport8a.FormKeyPress(Sender: TObject; var Key: Char);
//var fapp: boolean;
begin
...
procedure Tsetmedexport8a.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetmedexport8a.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetmedexport8a.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
//    commandtext:=commandtext+' left join (select bod_cd,order_id from tb_bill where bod_type_id=1) h on a.bod_id =h.order_id';
    commandtext:=commandtext+' where a.bod_type_id=42 and a.bod_status_id in (1,2) and a.busi_type=3 and a.comp_id='+inttostr(compid);
...
procedure Tsetmedexport8a.FormCreate(Sender: TObject);
begin
...
procedure Tsetmedexport8a.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetmedexport8a.dxDBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var fapp: boolean;
begin
...
procedure Tsetmedexport8a.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetmedexport8a.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetmedexport8a.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetmedexport8a.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetmedexport8a.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetmedexport8a.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetmedexport8a.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetmedexport8a.cdsbillBeforePost(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetmedexport8a.cdsbillReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetmedexport8a.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetmedexport8a.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetmedexport8a.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
    fieldbyname('amot').asfloat:=round(fieldbyname('price').asfloat*fieldbyname('qty').asfloat*100+0.01)/100;
end;

procedure Tsetmedexport8a.PageControl1Change(Sender: TObject);
begin
...
procedure Tsetmedexport8a.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetmedexport8a.dxDBGrid2DblClick(Sender: TObject);
begin
...
procedure Tsetmedexport8a.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetmedexport8a.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetmedexport8a.dxEdit1Click(Sender: TObject);
begin
dxEdit1.SelectAll;
dxEdit1.SetFocus;
end;

procedure Tsetmedexport8a.SpeedButton2Click(Sender: TObject);
//var s: string;
begin
...
begin
    if active=true then close;
    commandtext:='sp_updatestock42c 42,'+cdsbill.fieldbyname('bod_id').asstring+','+inttostr(curuserid);
    execute;
    close;
end;
...
procedure Tsetmedexport8a.dxDBGraphicEdit1AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetmedexport8a.dxDBGraphicEdit2AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetmedexport8a.dxDBGraphicEdit3AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetmedexport8a.dxDBGraphicEdit4AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetmedexport8a.dxDBGraphicEdit5AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetmedexport8a.dxDBGraphicEdit1Change(Sender: TObject);
begin
setupdatestatus;
//cdsbill.edit;
end;

procedure Tsetmedexport8a.dxDBGraphicEdit1GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass1').asstring));
end;

procedure Tsetmedexport8a.dxDBGraphicEdit2GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass2').asstring));
end;

procedure Tsetmedexport8a.dxDBGraphicEdit3GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass3').asstring));
end;

procedure Tsetmedexport8a.dxDBGraphicEdit4GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass4').asstring));
end;

procedure Tsetmedexport8a.dxDBGraphicEdit5GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass5').asstring));
end;

procedure Tsetmedexport8a.dxDBGraphicEdit1KeyDown(Sender: TObject;
...
procedure Tsetmedexport8a.qryimageAfterPost(DataSet: TDataSet);
begin
qryimage.ApplyUpdates(-1);
end;

procedure Tsetmedexport8a.MenuItem1Click(Sender: TObject);
var mi: integer;
begin
cdsbillBeforeEdit(nil);
...
procedure Tsetmedexport8a.N2Click(Sender: TObject);
...
procedure Tsetmedexport8a.N4Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t,mcd: string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
...
procedure Tsetmedexport8a.N6Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'列表1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tsetmedexport8a.SpeedButton3Click(Sender: TObject);
begin
with qry do
begin
	if active=True then close;
    ...
    commandtext:=commandtext+' left join tb_staff g on a.broker_id =g.sta_id';
    commandtext:=commandtext+' left join (select bod_cd,order_id from tb_bill where bod_type_id=1) h on a.bod_id =h.order_id';
    commandtext:=commandtext+' where a.bod_type_id=42 and a.busi_type=1 and a.bod_status_id=1 and a.comp_id='+inttostr(compid);
    // cate_id 1:商业 2:分销 3:终端战略 4:终端普通;    busi_type: 1销售,2退货,3调价
...
procedure Tsetmedexport8a.qryCalcFields(DataSet: TDataSet);
begin
with qry do
begin
    case fieldbyname('cate_id').asinteger of
...
procedure Tsetmedexport8a.PageControl2Change(Sender: TObject);
begin
...
procedure Tsetmedexport8a.DSqrydtlDataChange(Sender: TObject;
  Field: TField);
begin
SpeedButton10.Enabled:=(PageControl2.ActivePage=TabSheet5) and (qrydtl.active=True) and (qrydtl.recordcount>0);
end;

procedure Tsetmedexport8a.dxDBGrid4CustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: String; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
...
procedure Tsetmedexport8a.SpeedButton10Click(Sender: TObject);
var mi: integer;
begin
...
begin
	if active=True then close;
    commandtext:='select top 1 a.bod_id,a.bod_cd from tb_bill a,tb_bill_dtl b where bod_type_id=42 and a.bod_id=b.bod_id and b.rela_id1='+qrydtl.fieldbyname('dtl_id').asstring;
    open;
    if recordcount>0 then
    begin
...
begin
	if active=True then close;
    commandtext:='update a set src_id=c.src_id,dst_id=c.dst_id,agent_id=c.agent_id,cate_id=c.cate_id,bod_desc=''由'+qry.fieldbyname('bod_cd').asstring+'号两票销售单生成'',relative_id=c.bod_id,order_id=c.order_id';
...
procedure Tsetmedexport8a.cdsbill_dtldiscountChange(Sender: TField);
begin
with cdsbill_dtl do
begin
...
procedure Tsetmedexport8a.dxEdit2Click(Sender: TObject);
begin
dxEdit2.SelectAll;
dxEdit2.SetFocus;
end;

procedure Tsetmedexport8a.dxEdit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key=vk_return then // <Enter> key is pressed
begin
...
procedure Tsetmedexport8a.SpeedButton6Click(Sender: TObject);
begin
...
procedure Tsetmedexport8a.SpeedButton1Click(Sender: TObject);
begin
