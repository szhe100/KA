object setreport08: Tsetreport08
  Left = 137
  Top = 107
  AutoScroll = False
  Caption = #21830#19994#35843#25320#36153#29992#32479#35745#34920
  ClientHeight = 514
  ClientWidth = 1198
  Color = clBtnFace
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1level2: TdxDBGridDateColumn
      Alignment = taCenter
      DisableEditor = True
      Width = 60
      BandIndex = 0
    ...
    object dxDBGrid1f3: TdxDBGridMaskColumn
      DisableEditor = True
      Width = 45
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1fprice: TdxDBGridColumn
      DisableEditor = True
      Width = 55
      BandIndex = 0
      RowIndex = 0
    ...
    object dxDBGrid1fdiff: TdxDBGridMaskColumn
      Alignment = taRightJustify
      DisableEditor = True
      Width = 114
      BandIndex = 0
  ...
  object qry: TClientDataSet
    ...
    object qrydistrict1: TStringField
    ...
    object qrymed_name: TStringField
      DisplayLabel = #24320#25143#20135#21697#21517#31216
      FieldName = 'med_name'
      Size = 50
    end
    ...
    object qryfprice: TBCDField
      DisplayLabel = #34917#24046#21333#20215
      FieldName = 'fprice'
      ReadOnly = True
      DisplayFormat = '###,###,##0.00;; '
      Precision = 2
    ...
    object qryfdiff: TBCDField
      DisplayLabel = #34917#24046#37329#39069'('#27491#25910#36127#20184')'
      FieldName = 'fdiff'
      ReadOnly = True
      DisplayFormat = '###,##0.00;; '
      Precision = 15
    ...
    object qryckd_amot1: TBCDField
      DisplayLabel = #24050#26680#38144
      FieldName = 'ckd_amot1'
      DisplayFormat = '###,###,##0.00;; '
      Precision = 15
      Size = 2
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select top 1 src_id,dst_id from tb_bill ')
    Left = 415
    Top = 189
  ...
  object PopupMenu1: TPopupMenu
    ...
    Top = 174
    object N7: TMenuItem
      Caption = #29983#25104#35843#25320#36153#30003#35831#21333
      OnClick = N7Click
    end
    object N8: TMenuItem
      Caption = '-'
