...
begin
    ...
    commandtext:=commandtext+' where bod_type_id=43';
...
begin
    ...
    commandtext:=commandtext+' values ('+inttostr(compid)+',43,0,'+inttostr(curuserid)+',getdate(),cast(convert(char(10),getdate(),20) as datetime))';
