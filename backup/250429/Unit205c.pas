...
begin
    ...
    close;
    commandtext:='select top 10000 a.*,check_dt1=cast(convert(char(10),a.check_dt,20) as datetime),m.mate_name,agent=c.mate_name,deputy=c.receiver,c.acnt_bank,c.bank_account,creater=d.zname,checker=e.zname,';
