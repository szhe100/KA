...
procedure Tqryreport19.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryreport19.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tqryreport19.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
with qry do
begin
...
procedure Tqryreport19.qryBeforeDelete(DataSet: TDataSet);
begin
...
procedure Tqryreport19.qryAfterPost(DataSet: TDataSet);
begin
if qry.ChangeCount>0 then myupdaterefresh(qry,'tb_report06','rec_id','');
end;

procedure Tqryreport19.SpeedButton3Click(Sender: TObject);
var mi: integer;
begin
with qry do
begin
    ...
    commandtext:=commandtext+' left join tb_staff d on a.sign_by=d.sta_id';
{
    ...
    if ((Trim(dxLookupEdit1.text)<>'') or (Trim(dxButtonEdit5.text)<>'') or (Trim(dxButtonEdit6.text)<>'') or (Trim(dxButtonEdit7.text)<>''))
...
//    if Trim(dxButtonEdit2.text)<>'' then commandtext:=commandtext+' and a.mate_id='+inttostr(dxButtonEdit2.tag);
    ...
    if Trim(dxLookupEdit1.text)<>'' then commandtext:=commandtext+' and level_id1='+level1.fieldbyname('obj_id').asstring;
...
procedure Tqryreport19.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryreport19.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tqryreport19.FormCloseQuery(Sender: TObject;
...
procedure Tqryreport19.FormCreate(Sender: TObject);
begin
...
procedure Tqryreport19.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tqryreport19.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tqryreport19.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tqryreport19.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tqryreport19.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tqryreport19.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tqryreport19.qryBeforePost(DataSet: TDataSet);
begin
with dm.pubqry do
begin
    if active=true then close;
...
procedure Tqryreport19.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbroker do
begin
...
procedure Tqryreport19.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryreport19.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
begin
...
procedure Tqryreport19.Button1Click(Sender: TObject);
begin
with dm.pubqry do
begin
    if active=True then close;
...
procedure Tqryreport19.qryBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tqryreport19.N7Click(Sender: TObject);
begin
with qry do
begin
...
procedure Tqryreport19.N8Click(Sender: TObject);
var mi: integer;
begin
with qry do
begin
...
procedure Tqryreport19.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tqryreport19.qrydtlAfterPost(DataSet: TDataSet);
begin
if qrydtl.ChangeCount>0 then myupdaterefresh(qrydtl,'tb_report06dtl','dtl_id','');
end;

procedure Tqryreport19.qrydtlBeforeDelete(DataSet: TDataSet);
begin
if qry.fieldbyname('valid').asboolean=True then raise Exception.Create('本记录已生效，不可删除');
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tqryreport19.qrydtlBeforePost(DataSet: TDataSet);
begin
with qrydtl do
begin
    if state=dsinsert then
...
procedure Tqryreport19.dxDBGrid2mate_name1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickcustomer do
begin
...
procedure Tqryreport19.DSqrydtlStateChange(Sender: TObject);
begin
if qrydtl.state in [dsinsert,dsedit] then qry.edit;
end;

procedure Tqryreport19.wwDBNavigator1PostClick(Sender: TObject);
begin
...
procedure Tqryreport19.wwDBNavigator1CancelClick(Sender: TObject);
begin
if (qrydtl.State in [dsinsert,dsedit]) then qrydtl.cancelUpdates;
end;

procedure Tqryreport19.dxDBGrid2Enter(Sender: TObject);
begin
with qrydtl do
    if recordcount=0 then append;
end;

procedure Tqryreport19.dxButtonEdit5ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickmanager do
begin
...
procedure Tqryreport19.dxDBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tqryreport19.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryreport19.MenuItem9Click(Sender: TObject);
begin
...
procedure Tqryreport19.dxDBGrid1signerButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickmanager do
begin
...
procedure Tqryreport19.dxButtonEdit6ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with picklevel3 do
begin
...
procedure Tqryreport19.N10Click(Sender: TObject);
...
procedure Tqryreport19.qryAfterInsert(DataSet: TDataSet);
begin
with qry do
begin
...
procedure Tqryreport19.N11Click(Sender: TObject);
var i,mi,l,m,n,k,o,p,q,i1,i2,i3,i4,i5,i6,m1,m2,m3 : integer;
    s,t: string;
    mcd: string[20];
begin
...
procedure Tqryreport19.dxButtonEdit7ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with picklevel2 do
begin
...
procedure Tqryreport19.qryCalcFields(DataSet: TDataSet);
begin
with qry do
