...
var
  settrustfeeapply: Tsettrustfeeapply;
...
procedure Tsettrustfeeapply.setupdatestatus;    // 编辑状态
begin
...
procedure Tsettrustfeeapply.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsettrustfeeapply.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsettrustfeeapply.FormCloseQuery(Sender: TObject;
...
procedure Tsettrustfeeapply.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsettrustfeeapply.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsettrustfeeapply.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsettrustfeeapply.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsettrustfeeapply.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsettrustfeeapply.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.comp_id='+inttostr(compid)+' and a.bod_type_id=16';
...
procedure Tsettrustfeeapply.FormCreate(Sender: TObject);
begin
...
procedure Tsettrustfeeapply.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsettrustfeeapply.DSbillDataChange(Sender: TObject; Field: TField);
begin
    ...
    with cdsbill_dtl do
        if tag<>cdsbill.fieldbyname('bod_id').asinteger then
            ...
            begin
                ...
                commandtext:=commandtext+' where b.bod_id='+cdsbill.fieldbyname('bod_id').asstring+' and b.med_id=d.dtl_id and c.bod_id=d.bod_id and d.med_id=m.med_id';
edit1.text:=commandtext;
                try
                    setprogress(1);
                    open;
...
procedure Tsettrustfeeapply.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsettrustfeeapply.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsettrustfeeapply.SpeedButton2Click(Sender: TObject);
//var s: string;
begin
{
with cdsbill do
...
procedure Tsettrustfeeapply.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsettrustfeeapply.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsettrustfeeapply.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsettrustfeeapply.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsettrustfeeapply.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsettrustfeeapply.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsettrustfeeapply.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsettrustfeeapply.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsettrustfeeapply.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsettrustfeeapply.N1Click(Sender: TObject);
...
procedure Tsettrustfeeapply.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsettrustfeeapply.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsettrustfeeapply.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
