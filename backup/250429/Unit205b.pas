...
type
  Tsetexpay2 = class(TForm)
    ...
    dxDBGrid1deputy: TdxDBGridColumn;
...
begin
    ...
    close;
    commandtext:='select top 10000 a.*,m.mate_name,agent=c.mate_name,deputy=c.receiver,c.acnt_bank,c.bank_account,creater=d.zname,checker=e.zname,';
...
//                commandtext:=commandtext+' left join vi_bodstadtlmed c on b.bod_id=c.bod_id and (b.type_id=36 and b.med_id=c.bod_id1 or b.type_id=1 and b.med_id=c.dtl_id)';
//                commandtext:=commandtext+' left join vi_boddtlmed c on b.bod_id=c.bod_id and (b.type_id=36 and b.med_id=c.bod_id1 or b.type_id=1 and b.med_id=c.dtl_id)';
...
//                commandtext:=commandtext+' 	 on d.rec_id=dbo.fn_getbusiframerecid4(a.dst_id,a.agent_id,c.med_id,c.carry_dt)'; // and c.agent_id=case when h.agent_id>0 then h.agent_id else a.agent_id end';
