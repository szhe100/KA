object setreport15: Tsetreport15
  Left = 175
  Top = 115
  AutoScroll = False
  Caption = #38144#21806#25351#26631#25215#35834#34920
  ClientHeight = 496
  ClientWidth = 926
  Color = clBtnFace
  ...
  object SpeedButton1: TSpeedButton
    ...
    Width = 110
    Height = 25
    Hint = #20174#31532'2'#34892#24320#22987#23548#20837#65292#23548#20837#26684#24335': '#30465#20221','#22478#24066','#21307#38498#21517#31216','#26159#21542#30446#26631#21307#38498','#33647#21697#32534#30721','#26376#30446#26631#37327','#26376#28508#21147#37327','#26159#21542#38480#37327','#38480#37327#37329#39069
    Caption = #23548#20837'&Excel'
    Flat = True
    Glyph.Data = {
      76010000424D7601000000000000760000002800000020000000100000000100
  ...
  object Label11: TLabel
    ...
    Width = 516
    Height = 12
    Caption = #23548#20837#26684#24335': '#30465#20221','#22478#24066','#21307#38498#21517#31216','#26159#21542#30446#26631#21307#38498','#33647#21697#32534#30721','#26376#30446#26631#37327','#26376#28508#21147#37327','#26159#21542#38480#37327','#38480#37327#37329#39069
  end
  ...
  object Panel1: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      object dxDBGrid1istarget: TdxDBGridCheckColumn
        Color = 13303293
        Width = 55
        BandIndex = 0
        RowIndex = 0
      ...
      object dxDBGrid1qty13: TdxDBGridColumn
        Color = 13303293
        Width = 55
        BandIndex = 0
        RowIndex = 0
      ...
      object dxDBGrid1qty14: TdxDBGridColumn
        Color = 13303293
        MinWidth = 16
        Width = 55
        BandIndex = 0
  ...
  object qry: TClientDataSet
    ...
    object qryistarget: TBooleanField
      DisplayLabel = #30446#26631#21307#38498
      FieldName = 'istarget'
    end
    object qryqty0: TSmallintField
      DisplayLabel = #26376#30446#26631#37327
      FieldName = 'qty0'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty1: TSmallintField
      DisplayLabel = '1'#26376
      FieldName = 'qty1'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty2: TSmallintField
      DisplayLabel = '2'#26376
      FieldName = 'qty2'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty3: TSmallintField
      DisplayLabel = '3'#26376
      FieldName = 'qty3'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty4: TSmallintField
      DisplayLabel = '4'#26376
      FieldName = 'qty4'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty5: TSmallintField
      DisplayLabel = '5'#26376
      FieldName = 'qty5'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty6: TSmallintField
      DisplayLabel = '6'#26376
      FieldName = 'qty6'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty7: TSmallintField
      DisplayLabel = '7'#26376
      FieldName = 'qty7'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty8: TSmallintField
      DisplayLabel = '8'#26376
      FieldName = 'qty8'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty9: TSmallintField
      DisplayLabel = '9'#26376
      FieldName = 'qty9'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty10: TSmallintField
      DisplayLabel = '10'#26376
      FieldName = 'qty10'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty11: TSmallintField
      DisplayLabel = '11'#26376
      FieldName = 'qty11'
      DisplayFormat = '###,###,##0;; '
    end
    object qryqty12: TSmallintField
    ...
    object qryf1: TBooleanField
      DisplayLabel = #26159#21542#38480#37327
      FieldName = 'f1'
    end
    object qryqty13: TBCDField
      DisplayLabel = #26376#28508#21147#37327
      FieldName = 'qty13'
      DisplayFormat = '###,###,##0;; '
      Precision = 10
      Size = 0
    end
    object qryqty14: TBCDField
      DisplayLabel = #38480#37327#37329#39069
      FieldName = 'qty14'
      DisplayFormat = '###,###,##0;; '
      Precision = 10
      Size = 0
    ...
    object qrymodifier: TStringField
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1qty0: TSmallintField
      FieldName = 'qty0'
    end
    object ADOQuery1qty1: TSmallintField
      FieldName = 'qty1'
    end
    object ADOQuery1qty2: TSmallintField
      FieldName = 'qty2'
    end
    object ADOQuery1qty3: TSmallintField
      FieldName = 'qty3'
    end
    object ADOQuery1qty4: TSmallintField
      FieldName = 'qty4'
    end
    object ADOQuery1qty5: TSmallintField
      FieldName = 'qty5'
    end
    object ADOQuery1qty6: TSmallintField
      FieldName = 'qty6'
    end
    object ADOQuery1qty7: TSmallintField
      FieldName = 'qty7'
    end
    object ADOQuery1qty8: TSmallintField
      FieldName = 'qty8'
    end
    object ADOQuery1qty9: TSmallintField
      FieldName = 'qty9'
    end
    object ADOQuery1qty10: TSmallintField
      FieldName = 'qty10'
    end
    object ADOQuery1qty11: TSmallintField
      FieldName = 'qty11'
    end
    object ADOQuery1qty12: TSmallintField
      FieldName = 'qty12'
    end
    ...
    object ADOQuery1istarget: TBooleanField
      FieldName = 'istarget'
    end
    object ADOQuery1f1: TBooleanField
      FieldName = 'f1'
    end
    object ADOQuery1qty13: TBCDField
      FieldName = 'qty13'
      Precision = 10
      Size = 0
    end
    object ADOQuery1qty14: TBCDField
      FieldName = 'qty14'
      Precision = 10
      Size = 0
    end
  ...
  object qrydtl: TClientDataSet
    ...
    object qrydtlqty1: TSmallintField
      DisplayLabel = '1'#26376
      FieldName = 'qty1'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty2: TSmallintField
      DisplayLabel = '2'#26376
      FieldName = 'qty2'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty3: TSmallintField
      DisplayLabel = '3'#26376
      FieldName = 'qty3'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty4: TSmallintField
      DisplayLabel = '4'#26376
      FieldName = 'qty4'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty5: TSmallintField
      DisplayLabel = '5'#26376
      FieldName = 'qty5'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty6: TSmallintField
      DisplayLabel = '6'#26376
      FieldName = 'qty6'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty7: TSmallintField
      DisplayLabel = '7'#26376
      FieldName = 'qty7'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty8: TSmallintField
      DisplayLabel = '8'#26376
      FieldName = 'qty8'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty9: TSmallintField
      DisplayLabel = '9'#26376
      FieldName = 'qty9'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty10: TSmallintField
      DisplayLabel = '10'#26376
      FieldName = 'qty10'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty11: TSmallintField
      DisplayLabel = '11'#26376
      FieldName = 'qty11'
      DisplayFormat = '###,###,##0;; '
    end
    object qrydtlqty12: TSmallintField
      DisplayLabel = '12'#26376
      FieldName = 'qty12'
      DisplayFormat = '###,###,##0;; '
    end
