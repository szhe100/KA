...
type
  Tsetbrokerfeeapply3 = class(TForm)
...
var
  setbrokerfeeapply3: Tsetbrokerfeeapply3;
...
procedure Tsetbrokerfeeapply3.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetbrokerfeeapply3.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetbrokerfeeapply3.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetbrokerfeeapply3.FormCloseQuery(Sender: TObject;
...
procedure Tsetbrokerfeeapply3.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetbrokerfeeapply3.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbrokerfeeapply3.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetbrokerfeeapply3.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetbrokerfeeapply3.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetbrokerfeeapply3.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
procedure Tsetbrokerfeeapply3.FormCreate(Sender: TObject);
begin
...
procedure Tsetbrokerfeeapply3.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetbrokerfeeapply3.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokerfeeapply3.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokerfeeapply3.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetbrokerfeeapply3.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetbrokerfeeapply3.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetbrokerfeeapply3.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetbrokerfeeapply3.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetbrokerfeeapply3.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetbrokerfeeapply3.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetbrokerfeeapply3.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbrokerfeeapply3.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetbrokerfeeapply3.N1Click(Sender: TObject);
...
procedure Tsetbrokerfeeapply3.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure Tsetbrokerfeeapply3.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetbrokerfeeapply3.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetbrokerfeeapply3.SpeedButton6Click(Sender: TObject);
begin
...
procedure Tsetbrokerfeeapply3.N3Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'列表1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tsetbrokerfeeapply3.dxEdit2KeyDown(Sender: TObject;
...
procedure Tsetbrokerfeeapply3.SpeedButton2Click(Sender: TObject);
var s: string;
begin
...
procedure Tsetbrokerfeeapply3.SpeedButton3Click(Sender: TObject);
begin
with dm.pubqry do
begin
    if active then close;
