...
procedure Tpicklevel3.Edit1KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
    fwid: boolean;
...
begin
    ...
    begin
        ...
        commandtext:=commandtext+' where comp_id='+inttostr(compid)+' and obj_type_id=23';
...
//        commandtext:=commandtext+' order by zdesc';
        open;
        if recordcount=0 then begin beep; raise Exception.Create('无所查询小区'); end;
    end;
end;
end;

procedure Tpicklevel3.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpicklevel3.DBGrid1DblClick(Sender: TObject);
begin
   modalresult:=mrOK;
end;

procedure Tpicklevel3.wwDBNavigator1FirstClick(Sender: TObject);
begin
edit1.setfocus;
end;

procedure Tpicklevel3.FormCloseQuery(Sender: TObject;
...
procedure Tpicklevel3.FormActivate(Sender: TObject);
begin
edit1.setfocus;
edit1.selectall;
end;

procedure Tpicklevel3.BitBtn3Click(Sender: TObject);
begin
self.tag:=1;  // <Esc> (cancel) 退出标志
end;

procedure Tpicklevel3.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpicklevel3.DSquery1DataChange(Sender: TObject; Field: TField);
begin
if activecontrol=dbgrid1 then
edit1.text:=query1.fieldbyname('pick_ord').asstring;
end;

procedure Tpicklevel3.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
