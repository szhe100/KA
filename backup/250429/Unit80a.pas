...
begin
    ...
    begin
        ...
        speedbutton3.enabled:=(state=dsbrowse) and (active=true) and (recordcount>0)
             and (fieldbyname('bod_status_id').asinteger=2) and (fieldbyname('creat_by').asinteger=curuserid); // and (datetostr(fieldbyname('creat_dt').asdatetime)=datetostr(srv_date));
