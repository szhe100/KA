...
uses
  ...
  wwSpeedButton, wwDBNavigator, wwclearpanel, Buttons;

type
  Tqryclassimp2 = class(TForm)
...
procedure Tqryclassimp2.FormCloseQuery(Sender: TObject;
...
procedure Tqryclassimp2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryclassimp2.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryclassimp2.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
speedbutton2.enabled:=(qry.active=true) and (qry.recordcount>0);
end;

procedure Tqryclassimp2.FormCreate(Sender: TObject);
begin
...
procedure Tqryclassimp2.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tqryclassimp2.SpeedButton5Click(Sender: TObject);
var si: integer;
    ss: string[12];
begin
...
begin
    ...
    commandtext:='select dtl_id,a.bod_id,a.bod_cd,e.med_code,e.med_name,e.specifi,c.mate_name,a.agent_id,agent=d.mate_name,';
    ...
    commandtext:=commandtext+' a.cate_id,a.busi_type,a.sub_busi_id,b.lead_id,leader=dbo.fn_staff_name(b.lead_id),b.bod_cd1,b.bod_cd2,';
...
procedure Tqryclassimp2.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassimp2.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassimp2.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tqryclassimp2.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tqryclassimp2.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tqryclassimp2.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tqryclassimp2.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tqryclassimp2.qryCalcFields(DataSet: TDataSet);
begin
with qry do
begin
    ...
    end;
{
    ...
    fieldbyname('ccate_id').asstring:='战略KA';
    
    case fieldbyname('sub_busi_id').asinteger of
        1: fieldbyname('csubbusi').asstring:='战略KA';
        2: fieldbyname('csubbusi').asstring:='底价发货';
    end;
...
procedure Tqryclassimp2.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
    if showmodal= mrOK then
...
procedure Tqryclassimp2.dxDBGrid1DblClick(Sender: TObject);
begin
