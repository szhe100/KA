...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=2 and a.cate_id=2';   // a.comp_id='+inttostr(compid)+' and
...
//开始导入
//格式:1发生日期dt, 2医院id2, 3本公司产品编码id3, 4数量, 5批号, 6单据摘要, 7商业公司, 8代理人,9商业单价
...
//格式:1发生日期dt, 2医院id2, 3本公司产品编码id3, 4数量, 5批号, 6单据摘要, 7商业公司, 8代理人,9商业单价
            if active then close;
            commandtext:='insert into tb_bill_dtl (bod_id,med_id,qty,price,amot,price3,sta_id,lead_id,bat_cd)';
            commandtext:=commandtext+' values ('+inttostr(mid)+','+inttostr(id3)+',';
