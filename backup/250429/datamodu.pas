...
begin
    if not isexportable(curuserid) then raise Exception.Create('抱歉,你无权转出数据');
    with SaveDialog do
    begin
...
begin
  ...
  begin
    ...
    MessageBox(0,Pchar('文件:'+FileName+' 已成功转出'),'请注意',MB_OK+MB_ICONInformation);
  end;
end;
end;
