...
procedure Tsetreceive2a.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetreceive2a.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetreceive2a.FormActivate(Sender: TObject);
begin
//with dm.imp_type do
...
procedure Tsetreceive2a.FormCloseQuery(Sender: TObject;
...
procedure Tsetreceive2a.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetreceive2a.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetreceive2a.dxDBGrid2Enter(Sender: TObject);
begin
...
procedure Tsetreceive2a.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetreceive2a.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
//    commandtext:=commandtext+' fpic=cast(case when exists (select top 1 1 from tb_image where type_id=1 and id=a.bod_id and zimage1 is not null) then 1 else 0 end as bit)';
...
//    commandtext:=commandtext+' left join (select a.bod_id,carry_dt=max(b.valid_dt) from tb_bill a,tb_bill_dtl b where a.bod_type_id=45 and a.bod_id=b.bod_id group by a.bod_id) h on a.bod_id=h.bod_id';
    commandtext:=commandtext+' where a.bod_type_id=45 and a.bod_status_id in (1,2)';
...
procedure Tsetreceive2a.FormCreate(Sender: TObject);
begin
...
procedure Tsetreceive2a.SpeedButton6Click(Sender: TObject);
begin
...
procedure Tsetreceive2a.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetreceive2a.dxDBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var fapp: boolean;
begin
...
procedure Tsetreceive2a.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetreceive2a.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetreceive2a.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetreceive2a.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetreceive2a.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetreceive2a.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetreceive2a.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetreceive2a.cdsbillBeforePost(DataSet: TDataSet);
begin
with cdsbill do
begin
	if fieldbyname('zmemo').asstring='' then fieldbyname('zmemo').asstring:=' ';
...
procedure Tsetreceive2a.cdsbillReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetreceive2a.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetreceive2a.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetreceive2a.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
    fieldbyname('amot').asfloat:=round(fieldbyname('price').asfloat*fieldbyname('qty').asfloat*100+0.01)/100;
end;

procedure Tsetreceive2a.PageControl1Change(Sender: TObject);
begin
...
procedure Tsetreceive2a.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetreceive2a.dxDBGrid2DblClick(Sender: TObject);
begin
{
...
procedure Tsetreceive2a.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetreceive2a.N3Click(Sender: TObject);
...
procedure Tsetreceive2a.dxDBButtonEdit3Enter(Sender: TObject);
begin
(Sender as TdxDBButtonEdit).SelectAll;
end;

procedure Tsetreceive2a.dxDBButtonEdit3KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if (key=VK_RETURN) and (Shift=[ssCtrl]) then (Sender as TdxDBButtonEdit).OnButtonClick(nil,0);
end;

procedure Tsetreceive2a.dxDBButtonEdit3KeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tsetreceive2a.dxDBButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
begin
...
procedure Tsetreceive2a.dxDBButtonEdit1KeyPress(Sender: TObject;
  var Key: Char);
begin
if (key=#32) and ((Sender as TdxDBButtonEdit).Text<>'') then //
begin
...
procedure Tsetreceive2a.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetreceive2a.dxEdit1Click(Sender: TObject);
begin
dxEdit1.SelectAll;
dxEdit1.SetFocus;
end;

procedure Tsetreceive2a.dxDBButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetreceive2a.dxDBButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetreceive2a.dxDBGraphicEdit1AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetreceive2a.dxDBGraphicEdit2AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetreceive2a.dxDBGraphicEdit3AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetreceive2a.dxDBGraphicEdit4AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetreceive2a.dxDBGraphicEdit5AssignPicture(Sender: TObject;
  var Picture: TPicture);
begin
...
procedure Tsetreceive2a.dxDBGraphicEdit1Change(Sender: TObject);
begin
setupdatestatus;
//cdsbill.edit;
end;

procedure Tsetreceive2a.dxDBGraphicEdit1GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass1').asstring));
end;

procedure Tsetreceive2a.dxDBGraphicEdit2GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass2').asstring));
end;

procedure Tsetreceive2a.dxDBGraphicEdit3GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass3').asstring));
end;

procedure Tsetreceive2a.dxDBGraphicEdit4GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass4').asstring));
end;

procedure Tsetreceive2a.dxDBGraphicEdit5GetGraphicClass(Sender: TObject;
  var GraphicClass: TGraphicClass);
begin
GraphicClass := TGraphicClass(GetClass(qryimage.fieldbyname('graphclass5').asstring));
end;

procedure Tsetreceive2a.dxDBGraphicEdit1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure Tsetreceive2a.qryimageAfterPost(DataSet: TDataSet);
begin
qryimage.ApplyUpdates(-1);
end;

procedure Tsetreceive2a.N2Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t,mcd: string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
...
procedure Tsetreceive2a.N4Click(Sender: TObject);
...
begin
    ...
    for i:= 0 to dxDBGrid1.SelectedCount - 1 do
    begin
        if (dxDBGrid1.SelectedNodes[i].Values[j]=2) then
...
if mi=0 then raise Exception.Create('选择单据无效(限待审核状态的单据)');
with dm.pubqry do
begin
    if active=true then close;
    ...
    begin
        first;
        s:='下列单据商业公司收货人或收票人资料(姓名地址电话)不完整，不可审核'+ #13#10;
        s:=s+'-----------------------------------------------------';  //+ #13#10
...
if MessageBox(0,'确定所选单据通过审核','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
setprogress(1);
with dm.pubqry do
begin
    if active=true then close;
    ...
    begin
        ...
        begin
            if active=true then close;
            if sender= N4 then commandtext:='sp_updatestock45 45,'+dm.pubqry.fieldbyname('bod_id').asstring+','+inttostr(curuserid);
...
procedure Tsetreceive2a.N5Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t,mcd: string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
...
procedure Tsetreceive2a.SpeedButton2Click(Sender: TObject);
begin
...
begin
    if active=true then close;
    commandtext:='sp_updatestock45 45,'+cdsbill.fieldbyname('bod_id').asstring+','+inttostr(curuserid);
    execute;
    close;
end;
...
procedure Tsetreceive2a.SpeedButton3Click(Sender: TObject);
begin
...
procedure Tsetreceive2a.N7Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'列表1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tsetreceive2a.SpeedButton8Click(Sender: TObject);
begin
...
procedure Tsetreceive2a.SpeedButton9Click(Sender: TObject);
begin
