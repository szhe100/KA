object pickmed_bat1: Tpickmed_bat1
  Left = 129
  Top = 132
  ...
  AutoScroll = False
  BorderIcons = []
  Caption = #26597#35810#21307#38498#24211#23384#33647#21697
  ClientHeight = 476
  ClientWidth = 820
  Color = clBtnFace
  ...
  object DBGrid1: TdxDBGrid
    ...
    object DBGrid1agent: TdxDBGridColumn
      Font.Charset = GB2312_CHARSET
      Font.Color = clNavy
      Font.Height = -12
      Font.Name = #23435#20307
    ...
    object DBGrid1bat_cd: TdxDBGridColumn
      Font.Charset = GB2312_CHARSET
      Font.Color = clGreen
      Font.Height = -12
      Font.Name = #23435#20307
    ...
    object DBGrid1low_limit_price: TdxDBGridColumn
    ...
    object DBGrid1qty1: TdxDBGridColumn
    ...
    object DBGrid1price: TdxDBGridColumn
      Font.Charset = GB2312_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = #23435#20307
    ...
    object DBGrid1valid_dt: TdxDBGridColumn
      Alignment = taCenter
      Width = 55
      BandIndex = 0
      RowIndex = 0
    ...
    object DBGrid1otc_rx: TdxDBGridCheckColumn
      MinWidth = 20
      Width = 25
      BandIndex = 0
      RowIndex = 0
    ...
    object DBGrid1gmp: TdxDBGridCheckColumn
      Width = 25
      BandIndex = 0
      RowIndex = 0
      FieldName = 'gmp'
  ...
  object query1: TClientDataSet
    ...
    object query1agent: TStringField
      DisplayLabel = #37197#36865#21830
      FieldName = 'agent'
    end
    object query1med_id: TAutoIncField
      FieldName = 'med_id'
      ReadOnly = True
    end
    object query1valid_dt: TDateTimeField
      DisplayLabel = #26377#25928#26399#33267
      FieldName = 'valid_dt'
      DisplayFormat = 'yy-mm-dd'
    end
    object query1med_code: TStringField
      DisplayLabel = #32534#30721
      FieldName = 'med_code'
    end
    object query1med_name: TStringField
      DisplayLabel = #36890#29992#21517
      FieldName = 'med_name'
      Size = 50
    end
    object query1chm_name: TStringField
      DisplayLabel = #21830#21697#21517
      FieldName = 'chm_name'
      Size = 50
    end
    object query1specifi: TStringField
      DisplayLabel = #35268#26684
      FieldName = 'specifi'
      Size = 50
    end
    object query1pdt_place: TStringField
      DisplayLabel = #29983#20135#20225#19994
      FieldName = 'pdt_place'
      Size = 30
    end
    object query1med_unit: TStringField
    ...
    object query1price: TBCDField
      DisplayLabel = #25209#27425#21333#20215
      FieldName = 'price'
      DisplayFormat = '###,###,##0.00##;; '
      Precision = 15
      Size = 5
    ...
    object query1qtyperpack: TBCDField
    ...
    object query1qtyperbox: TBCDField
    ...
    object query1otc_rx: TBooleanField
      DisplayLabel = 'OTC'
      FieldName = 'otc_rx'
    end
    object query1gmp: TBooleanField
      DisplayLabel = 'GMP'
      FieldName = 'gmp'
    end
  end
  object ADOQuery1: TADOQuery
    ...
    Left = 404
    Top = 2
    object ADOQuery1med_id: TAutoIncField
      FieldName = 'med_id'
      ReadOnly = True
    end
    ...
    object ADOQuery1chm_qrycode: TStringField
      FieldName = 'chm_qrycode'
    end
    object ADOQuery1med_alia: TStringField
      FieldName = 'med_alia'
      Size = 50
    end
    object ADOQuery1foreigname: TStringField
    ...
    object ADOQuery1med_type_id: TIntegerField
    ...
    object ADOQuery1qtyperbox: TBCDField
      FieldName = 'qtyperbox'
      Precision = 18
      Size = 0
    end
    ...
    object ADOQuery1otc_rx: TBooleanField
      FieldName = 'otc_rx'
    end
    object ADOQuery1barcode: TStringField
      FieldName = 'barcode'
    end
    object ADOQuery1appv_docu: TStringField
      FieldName = 'appv_docu'
      Size = 40
    end
    object ADOQuery1special_treat: TBooleanField
      FieldName = 'special_treat'
    end
    object ADOQuery1qry_code: TStringField
      FieldName = 'qry_code'
    end
    object ADOQuery1site_code: TStringField
      FieldName = 'site_code'
    end
    object ADOQuery1pick_ord: TIntegerField
      FieldName = 'pick_ord'
    end
    object ADOQuery1valid_period: TIntegerField
      FieldName = 'valid_period'
    end
    object ADOQuery1GMP: TBooleanField
      FieldName = 'GMP'
    end
