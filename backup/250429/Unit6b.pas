...
begin
    ...
    commandtext:=commandtext+' dist1=d.prov_name,'; //  dbo.fn_getdistrictlevel (a.district_id,1),';
    commandtext:=commandtext+' dist2=d.city_name,'; //  dbo.fn_getdistrictlevel (a.district_id,2),';
    ...
    commandtext:=commandtext+' left join tb_district d on a.district_id =d.rec_id';
