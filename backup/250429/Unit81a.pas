...
procedure Tpickaccounts.FormActivate(Sender: TObject);
begin
edit1.setfocus;
edit1.selectall;
with qryacc do
...
procedure Tpickaccounts.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
if key in ['0'..'9'] then
begin
    edit1.Text:=key;
...
procedure Tpickaccounts.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickaccounts.Edit1KeyPress(Sender: TObject;
  var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
...
procedure Tpickaccounts.dxDBTreeList1CustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
...
procedure Tpickaccounts.dxDBTreeList1GetStateIndex(Sender: TObject;
  Node: TdxTreeListNode; var Index: Integer);
begin
...
procedure Tpickaccounts.btnFullCollapseClick(Sender: TObject);
begin
  dxDBTreeList1.FullCollapse;
end;

procedure Tpickaccounts.btnFullExpandClick(Sender: TObject);
begin
  dxDBTreeList1.FullExpand;
end;

procedure Tpickaccounts.dxDBTreeList1DblClick(Sender: TObject);
begin
with qryacc do
    if (active=true) and (fieldbyname('haschild').asboolean=false) then modalresult:=mrOK;
end;

procedure Tpickaccounts.dxDBTreeList1KeyDown(Sender: TObject;
...
procedure Tpickaccounts.FormClose(Sender: TObject;
