...
type
  Tsetbusipriceapply2 = class(TForm)
...
var
  setbusipriceapply2: Tsetbusipriceapply2;
...
procedure Tsetbusipriceapply2.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetbusipriceapply2.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetbusipriceapply2.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetbusipriceapply2.FormCloseQuery(Sender: TObject;
...
procedure Tsetbusipriceapply2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetbusipriceapply2.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbusipriceapply2.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetbusipriceapply2.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetbusipriceapply2.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetbusipriceapply2.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=51';
...
procedure Tsetbusipriceapply2.FormCreate(Sender: TObject);
begin
...
procedure Tsetbusipriceapply2.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetbusipriceapply2.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetbusipriceapply2.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbusipriceapply2.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbusipriceapply2.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetbusipriceapply2.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetbusipriceapply2.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetbusipriceapply2.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetbusipriceapply2.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetbusipriceapply2.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetbusipriceapply2.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetbusipriceapply2.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetbusipriceapply2.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbusipriceapply2.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetbusipriceapply2.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure Tsetbusipriceapply2.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetbusipriceapply2.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
