...
//    commandtext:=commandtext+' left join tb_staff b on a.broker_id=b.sta_id';
    ...
    commandtext:='select top 3 b.district,b.mate_name,m.med_code,m.med_name,m.specifi,m.pdt_place';
...
edit5.text:=commandtext;
    ...
    begin
        ...
        while not eof do
        begin
            s := s+ #13#10 +fieldbyname('mate_name').asstring+' '+fieldbyname('med_code').asstring+' '+fieldbyname('med_name').asstring+' '+fieldbyname('specifi').asstring+' '+fieldbyname('pdt_place').asstring;
            next;
        end;
        MessageBox(0,pchar(s),'请注意',MB_OK+MB_IconError);
        abort;
