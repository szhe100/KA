...
procedure Tqryreport17.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryreport17.SpeedButton2Click(Sender: TObject);
begin
...
begin
    ...
    commandtext:=commandtext+' left join tb_report04dtl f on a.rec_id=f.rec_id';
...
procedure Tqryreport17.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
with qry do
begin
...
procedure Tqryreport17.qryBeforeDelete(DataSet: TDataSet);
begin
...
procedure Tqryreport17.qryAfterPost(DataSet: TDataSet);
begin
...
procedure Tqryreport17.SpeedButton3Click(Sender: TObject);
var mi: integer;
begin
with qry do
begin
...
procedure Tqryreport17.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryreport17.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tqryreport17.FormCloseQuery(Sender: TObject;
...
procedure Tqryreport17.FormCreate(Sender: TObject);
begin
...
procedure Tqryreport17.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tqryreport17.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tqryreport17.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tqryreport17.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tqryreport17.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tqryreport17.dxLookupTreeView1CloseUp(Sender: TObject;
  Accept: Boolean);
begin
speedbutton4.Enabled:=(dxbuttonedit1.tag<>0) and (dxLookupTreeView1.text<>'');
end;

procedure Tqryreport17.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tqryreport17.qryBeforePost(DataSet: TDataSet);
begin
with qry do
begin
...
procedure Tqryreport17.SpeedButton5Click(Sender: TObject);
begin
with qry do
begin
...
procedure Tqryreport17.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryreport17.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryreport17.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
begin
...
procedure Tqryreport17.Button1Click(Sender: TObject);
begin
with dm.pubqry do
begin
    if active=True then close;
...
procedure Tqryreport17.qryBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tqryreport17.N7Click(Sender: TObject);
begin
with qry do
begin
    if (active=False) or (recordcount=0) then exit;
...
procedure Tqryreport17.N8Click(Sender: TObject);
var mi: integer;
begin
with qry do
begin
...
procedure Tqryreport17.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tqryreport17.SpeedButton6Click(Sender: TObject);
var
    XL,Sheet: Variant;
    SFileName: string;
...
procedure Tqryreport17.qrydtlAfterPost(DataSet: TDataSet);
begin
if qrydtl.ChangeCount>0 then myupdaterefresh(qrydtl,'tb_report04dtl','dtl_id','');
end;

procedure Tqryreport17.qrydtlBeforeDelete(DataSet: TDataSet);
begin
if qry.fieldbyname('valid').asboolean=True then raise Exception.Create('本记录已生效，不可删除');
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tqryreport17.qrydtlBeforePost(DataSet: TDataSet);
begin
with qrydtl do
begin
    if state=dsinsert then
...
procedure Tqryreport17.dxDBGrid2mate_name1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickcustomer do
begin
...
procedure Tqryreport17.DSqrydtlStateChange(Sender: TObject);
begin
if qrydtl.state in [dsinsert,dsedit] then qry.edit;
end;

procedure Tqryreport17.wwDBNavigator1PostClick(Sender: TObject);
begin
...
procedure Tqryreport17.wwDBNavigator1CancelClick(Sender: TObject);
begin
if (qrydtl.State in [dsinsert,dsedit]) then qrydtl.cancelUpdates;
end;

procedure Tqryreport17.dxDBGrid2Enter(Sender: TObject);
begin
with qrydtl do
    if recordcount=0 then append;
end;

procedure Tqryreport17.dxButtonEdit5ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickmanager do
begin
...
procedure Tqryreport17.dxDBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
//var fapp: boolean;
begin
...
procedure Tqryreport17.dxDBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
{
...
procedure Tqryreport17.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryreport17.MenuItem9Click(Sender: TObject);
begin
...
procedure Tqryreport17.dxDBGrid1signerButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickmanager do
begin
...
procedure Tqryreport17.dxButtonEdit6ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with picklevel3 do
begin
