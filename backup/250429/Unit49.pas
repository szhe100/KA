...
type
  Tsetallotruleapply = class(TForm)
...
var
  setallotruleapply: Tsetallotruleapply;
//  ptype: string[20];
//  pcent: real;
...
procedure Tsetallotruleapply.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetallotruleapply.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetallotruleapply.FormActivate(Sender: TObject);
begin
{
with dm.fee_type do
...
procedure Tsetallotruleapply.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotruleapply.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotruleapply.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotruleapply.DSbill_dtlDataChange(Sender: TObject;
  Field: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotruleapply.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetallotruleapply.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetallotruleapply.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetallotruleapply.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=22';    // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetallotruleapply.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotruleapply.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetallotruleapply.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetallotruleapply.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotruleapply.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotruleapply.SpeedButton2Click(Sender: TObject);
var s: string;
begin
{
with cdsbill do
...
procedure Tsetallotruleapply.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetallotruleapply.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetallotruleapply.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetallotruleapply.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetallotruleapply.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetallotruleapply.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetallotruleapply.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotruleapply.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotruleapply.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotruleapply.N1Click(Sender: TObject);
...
procedure Tsetallotruleapply.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetallotruleapply.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotruleapply.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetallotruleapply.brokermedtlCalcFields(DataSet: TDataSet);
begin
with brokermedtl do
begin
...
procedure Tsetallotruleapply.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
