...
procedure Tsetbroker.DBCheckBox1Click(Sender: TObject);
begin
with dbcheckbox1 do
...
begin
    ...
    setprogress(1);
//从第2行开始导入，导入格式: 1业务员编码,2业务员名称,3所在地区,4电子邮箱,5联系电话,6收款人,7开户银行,8帐户
    mi:=0;j:=2;  //第1行开始 每行一单
    ...
    begin
        ...
        begin
            if active=true then close;
            commandtext:='select top 1 1 from tb_staff where comp_id='+inttostr(compid)+' and sta_type_id=1 and zcode='''+s1+'''';
            open;
