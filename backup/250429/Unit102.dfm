object setreport24: Tsetreport24
  Left = 91
  Top = 97
  AutoScroll = False
  Caption = #20379#24212#21830#36820#20837#26680#38144'('#29983#25104#36820#20837#25910#27454#21333')'
  ClientHeight = 564
  ClientWidth = 1231
  Color = clBtnFace
  ...
  object Label11: TLabel
    ...
    Width = 168
    Height = 12
    Caption = #26377#26465#20214#26597#35810#26102#65292#26085#26399#33539#22260#26080#38480#21046
  end
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    Bands = <
      ...
      item
        Caption = #36820#20837#26680#38144
      end
      item
    ...
    object dxDBGrid1Camot1: TdxDBGridColumn
      Caption = #38144#21806'/'#35843#20215#37329#39069
      Width = 90
      BandIndex = 0
      RowIndex = 0
      FieldName = 'Camot1'
    ...
    object dxDBGrid1cnot_amot1: TdxDBGridColumn
      Width = 90
      BandIndex = 1
      RowIndex = 0
      FieldName = 'cnot_amot1'
      SummaryFooterType = cstSum
      SummaryFooterField = 'cnot_amot1'
      SummaryFooterFormat = '###,###,##0.00;; '
      DisableFilter = True
      SummaryType = cstSum
      SummaryField = 'cnot_amot1'
      SummaryFormat = '###,###,##0.00;; '
    end
    ...
    object dxDBGrid1Cfinished: TdxDBGridCheckColumn
      Width = 93
      BandIndex = 1
      RowIndex = 0
      FieldName = 'Cfinished'
    ...
    object dxDBGrid1recdt: TdxDBGridColumn
      Alignment = taCenter
      Width = 55
      BandIndex = 1
      RowIndex = 0
    ...
    object dxDBGrid1reccd: TdxDBGridColumn
      Alignment = taCenter
      Font.Charset = GB2312_CHARSET
      Font.Color = clPurple
      Font.Height = -12
    ...
    object dxDBGrid1credit_day: TdxDBGridColumn
      Alignment = taCenter
      Width = 55
      BandIndex = 1
      RowIndex = 0
    ...
    object dxDBGrid1Cexceeddays: TdxDBGridColumn
      Alignment = taCenter
      Width = 55
      BandIndex = 1
      RowIndex = 0
      FieldName = 'Cexceeddays'
      DisableFilter = True
    end
    ...
    object dxDBGrid1cnot_amot3: TdxDBGridColumn
      Width = 75
      BandIndex = 3
      RowIndex = 0
      FieldName = 'cnot_amot3'
      SummaryFooterType = cstSum
      SummaryFooterField = 'cnot_amot3'
      SummaryFooterFormat = '###,###,##0.00;; '
      DisableFilter = True
      SummaryType = cstSum
      SummaryField = 'cnot_amot3'
      SummaryFormat = '###,###,##0.00;; '
    end
    object dxDBGrid1Camot: TdxDBGridColumn
      Caption = #20854#20013':'#38144#21806#26410#25910#27454#25968#37327#30340#26410#36820#20837#27454
      Width = 180
      BandIndex = 3
      RowIndex = 0
      FieldName = 'Camot'
  ...
  object qry: TClientDataSet
    ...
    object qryprice1: TBCDField
      DisplayLabel = #38144#21806'/'#35843#20215
      FieldName = 'price1'
      ReadOnly = True
      DisplayFormat = '###,##0.00##;; '
      EditFormat = '########0.00##;; '
    ...
    object qrycarrydays: TIntegerField
      DisplayLabel = #21457#29983#22825#25968
      FieldName = 'carrydays'
      ReadOnly = True
    end
    object qryCexceeddays: TIntegerField
    ...
    object qryCqty2: TBCDField
      DisplayLabel = #26410#25910#27454#25968#37327
      FieldKind = fkCalculated
      FieldName = 'Cqty2'
      DisplayFormat = '###,###,##0;; '
      EditFormat = '########0;; '
    ...
    object qryCqty3: TBCDField
      DisplayLabel = #21378#23478#26410#36820#25968#37327
      FieldKind = fkCalculated
      FieldName = 'Cqty3'
      DisplayFormat = '###,###,##0;; '
      EditFormat = '########0;; '
    ...
    object qryCamot: TBCDField
      DisplayLabel = #20854#20013':'#26410#25910#27454#25968#37327#30340#26410#36820#20837#27454
      FieldKind = fkCalculated
      FieldName = 'Camot'
      DisplayFormat = '###,###,##0.00##;; '
      EditFormat = '########0.00##;; '
