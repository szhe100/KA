...
procedure Tsetreport11a.FormCloseQuery(Sender: TObject;
...
procedure Tsetreport11a.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetreport11a.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetreport11a.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
with qry do
begin
...
procedure Tsetreport11a.FormCreate(Sender: TObject);
begin
...
procedure Tsetreport11a.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetreport11a.SpeedButton5Click(Sender: TObject);
var mi: integer;
begin
...
procedure Tsetreport11a.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetreport11a.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetreport11a.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetreport11a.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tsetreport11a.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tsetreport11a.N7Click(Sender: TObject);
...
procedure Tsetreport11a.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbroker do
...
procedure Tsetreport11a.MenuItem3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetreport11a.MenuItem5Click(Sender: TObject);
begin
with dxdbgrid2 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetreport11a.MenuItem6Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid2 do
...
procedure Tsetreport11a.MenuItem8Click(Sender: TObject);
begin
...
procedure Tsetreport11a.PageControl1Change(Sender: TObject);
begin
if PageControl1.ActivePage=TabSheet1 then wwDBNavigator1.DataSource:=DSqry
    else wwDBNavigator1.DataSource:=DSqry1;
end;

procedure Tsetreport11a.qry1CalcFields(DataSet: TDataSet);
begin
with qry1 do
begin
...
procedure Tsetreport11a.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetreport11a.dxDBGrid2CustomDrawCell(Sender: TObject;
