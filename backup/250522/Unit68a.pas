...
type
  Tsetallotfeeapply1 = class(TForm)
...
var
  setallotfeeapply1: Tsetallotfeeapply1;
...
procedure Tsetallotfeeapply1.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetallotfeeapply1.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetallotfeeapply1.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetallotfeeapply1.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotfeeapply1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotfeeapply1.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply1.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetallotfeeapply1.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetallotfeeapply1.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetallotfeeapply1.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=15 and a.bod_status_id in (1,2,3,4)';    // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetallotfeeapply1.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotfeeapply1.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply1.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetallotfeeapply1.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply1.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply1.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply1.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetallotfeeapply1.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetallotfeeapply1.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetallotfeeapply1.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetallotfeeapply1.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetallotfeeapply1.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetallotfeeapply1.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotfeeapply1.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply1.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotfeeapply1.N1Click(Sender: TObject);
...
procedure Tsetallotfeeapply1.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetallotfeeapply1.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotfeeapply1.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
...
procedure Tsetallotfeeapply1.SpeedButton6Click(Sender: TObject);
begin
