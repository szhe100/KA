...
procedure Tsetexpaybook3.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetexpaybook3.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetexpaybook3.FormActivate(Sender: TObject);
begin
with dm.homebank do
...
procedure Tsetexpaybook3.FormCloseQuery(Sender: TObject;
...
procedure Tsetexpaybook3.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetexpaybook3.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetexpaybook3.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetexpaybook3.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetexpaybook3.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
setprogress(1);
...
procedure Tsetexpaybook3.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
//    commandtext:=commandtext+' ,a.channel_id,channel=dbo.fn_obj_desc(a.channel_id),a.channel_dtl_id,channel_dtl=dbo.fn_obj_desc(a.channel_dtl_id)';
    ...
    commandtext:=commandtext+' where bod_type_id=43 and cate_id=2';
...
procedure Tsetexpaybook3.FormCreate(Sender: TObject);
begin
...
procedure Tsetexpaybook3.SpeedButton6Click(Sender: TObject);
var mid:integer;
begin
with dm.pubqry do
begin
    ...
    commandtext:=commandtext+' values ('+inttostr(compid)+',43,0,2,'+inttostr(curuserid)+',getdate(),cast(convert(char(10),getdate(),20) as datetime))';
...
procedure Tsetexpaybook3.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetexpaybook3.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetexpaybook3.DSbillStateChange(Sender: TObject);
begin
with bill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetexpaybook3.billBeforeEdit(DataSet: TDataSet);
begin
with bill do
begin
...
procedure Tsetexpaybook3.billCalcFields(DataSet: TDataSet);
begin
with bill do
begin
...
procedure Tsetexpaybook3.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetexpaybook3.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetexpaybook3.dxDBEdit3KeyPress(Sender: TObject; var Key: Char);
begin
if key in ['a'..'z'] then key:=chr(ord(key)-32);   // turn lower charactor to upper
end;

procedure Tsetexpaybook3.SpeedButton2Click(Sender: TObject);
begin
with bill do
begin
...
procedure Tsetexpaybook3.SpeedButton4Click(Sender: TObject);
begin
{
...
procedure Tsetexpaybook3.Edit1KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
...
procedure Tsetexpaybook3.Edit1Click(Sender: TObject);
begin
edit1.selectall;
end;

procedure Tsetexpaybook3.dxDBButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
begin
...
procedure Tsetexpaybook3.dxDBButtonEdit1Enter(Sender: TObject);
begin
(Sender as TdxDBButtonEdit).SelectAll;
end;

procedure Tsetexpaybook3.dxDBButtonEdit1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if (key=VK_RETURN) and (Shift=[ssCtrl]) then (Sender as TdxDBButtonEdit).OnButtonClick(nil,0);
end;

procedure Tsetexpaybook3.dxDBButtonEdit1KeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tsetexpaybook3.dxDBButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetexpaybook3.Button1Click(Sender: TObject);
begin
SpeedButton2Click(nil);
end;

procedure Tsetexpaybook3.dxDBButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickchannel do
begin
...
procedure Tsetexpaybook3.dxDBButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
