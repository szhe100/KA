...
type
  Tpickbusimate2 = class(TForm)
    ...
    DBGrid1zname1: TdxDBGridMaskColumn;
    ...
    Edit1: TdxEdit;
    Label2: TLabel;
    query1zname1: TStringField;
    query1address1: TStringField;
    query1phone1: TStringField;
    query1zname2: TStringField;
    query1address2: TStringField;
    query1phone2: TStringField;
    DBGrid1address1: TdxDBGridColumn;
    DBGrid1phone1: TdxDBGridColumn;
    DBGrid1zname2: TdxDBGridColumn;
    DBGrid1address2: TdxDBGridColumn;
    DBGrid1phone2: TdxDBGridColumn;
...
procedure Tpickbusimate2.Edit1KeyPress(Sender: TObject; var Key: Char);
var //sc: string;
    //mi: integer;
    sk: widestring;
    //fwid: boolean;
...
procedure Tpickbusimate2.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickbusimate2.DBGrid1DblClick(Sender: TObject);
begin
   modalresult:=mrOK;
end;

procedure Tpickbusimate2.wwDBNavigator1FirstClick(Sender: TObject);
begin
edit1.setfocus;
end;

procedure Tpickbusimate2.FormCloseQuery(Sender: TObject;
...
procedure Tpickbusimate2.FormActivate(Sender: TObject);
begin
edit1.setfocus;
edit1.selectall;
end;

procedure Tpickbusimate2.BitBtn3Click(Sender: TObject);
begin
self.tag:=1;  // <Esc> (cancel) 退出标志
end;

procedure Tpickbusimate2.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickbusimate2.DSquery1DataChange(Sender: TObject; Field: TField);
begin
if activecontrol=dbgrid1 then
edit1.text:=query1.fieldbyname('pick_ord').asstring;
end;

procedure Tpickbusimate2.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
