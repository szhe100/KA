...
//    commandtext:=commandtext+' left join tb_busiframe k on b.med_id=k.med_id and j.district =k.district_id';
    commandtext:=commandtext+' where a.bod_type_id=2 and a.cate_id=7';  // a.comp_id='+inttostr(compid)+' and a.bod_status_id=1
...
procedure Tqryclassexp6.dxDBGrid1DblClick(Sender: TObject);
begin
...
procedure Tqryclassexp6.SpeedButton6Click(Sender: TObject);
...
procedure Tqryclassexp6.N7Click(Sender: TObject);
begin
with qry do
	if (active=False) or (recordcount=0) then exit;
with dm.pubqry do
