...
var
  setexpaycheck1: Tsetexpaycheck1;
...
procedure Tsetexpaycheck1.FormCloseQuery(Sender: TObject;
...
procedure Tsetexpaycheck1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetexpaycheck1.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetexpaycheck1.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
with qry do
begin
...
procedure Tsetexpaycheck1.FormCreate(Sender: TObject);
begin
...
procedure Tsetexpaycheck1.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag);
end;

procedure Tsetexpaycheck1.SpeedButton5Click(Sender: TObject);
...
//     and a.carry_dt>='''+datetostr(dxdateedit1.date)+'''';
    ...
    commandtext:=commandtext+' where a.bod_type_id=43 and a.bod_status_id=1 and a.cate_id=1';
    if Trim(dxEdit1.text)<>'' then commandtext:=commandtext+' and a.bod_cd='''+trim(dxEdit1.text)+''''
//        if Trim(dxEdit1.text)<>'' then commandtext:=commandtext+' and a.bod_cd like ''%'+trim(dxEdit1.text)+'%'''
    else
    begin
...
procedure Tsetexpaycheck1.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetexpaycheck1.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetexpaycheck1.qryCalcFields(DataSet: TDataSet);
begin
with qry do
begin
...
procedure Tsetexpaycheck1.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetexpaycheck1.N1Click(Sender: TObject);
...
procedure Tsetexpaycheck1.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
    if showmodal= mrOK then
...
procedure Tsetexpaycheck1.N5Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetexpaycheck1.N7Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetexpaycheck1.N8Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tsetexpaycheck1.N10Click(Sender: TObject);
begin
...
procedure Tsetexpaycheck1.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetexpaycheck1.N2Click(Sender: TObject);
begin
if (qry.active=false) or (qry.recordcount=0) then exit;
with dm.pubqry do
begin
...
procedure Tsetexpaycheck1.qryAfterPost(DataSet: TDataSet);
begin
//showmessage('');
...
procedure Tsetexpaycheck1.N3Click(Sender: TObject);
...
procedure Tsetexpaycheck1.SpeedButton1Click(Sender: TObject);
begin
...
procedure Tsetexpaycheck1.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetexpaycheck1.dxDBGrid1Click(Sender: TObject);
var amt: real;
    i,o,p,q: integer;
begin
with dxDBGrid1 do
...
procedure Tsetexpaycheck1.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetexpaycheck1.qryBeforePost(DataSet: TDataSet);
begin
with qry do
begin
...
procedure Tsetexpaycheck1.dxDateEdit1DblClick(Sender: TObject);
...
procedure Tsetexpaycheck1.dxDateEdit2DblClick(Sender: TObject);
var Year, Month, Day: Word;
begin
//showmessage(datetostr(dxDateEdit1.date));
decodedate(dxDateEdit2.date,year,month,day);
...
procedure Tsetexpaycheck1.N11Click(Sender: TObject);
var s: string;
begin
with dm.pubqry do
begin
