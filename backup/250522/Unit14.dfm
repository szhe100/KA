object pickmed_bat: Tpickmed_bat
  Left = 178
  Top = 129
  ...
  AutoScroll = False
  BorderIcons = []
  Caption = #26597#35810#33647#21697
  ClientHeight = 476
  ClientWidth = 820
  Color = clBtnFace
  ...
  object DBGrid1: TdxDBGrid
    ...
    object DBGrid1Ccate: TdxDBGridColumn
      Alignment = taCenter
      DisableEditor = True
      Width = 30
      BandIndex = 0
  ...
  object query1: TClientDataSet
    ...
    object query1rec_id: TAutoIncField
      FieldName = 'rec_id'
      ReadOnly = True
    end
    object query1parent_id: TIntegerField
      FieldName = 'parent_id'
    end
    object query1comp_id: TWordField
      FieldName = 'comp_id'
    end
    object query1mate_id: TIntegerField
      FieldName = 'mate_id'
    end
    ...
    object query1cate_id: TWordField
      FieldName = 'cate_id'
    end
    object query1Ccate: TStringField
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1parent_id: TIntegerField
      FieldName = 'parent_id'
    end
