...
begin
    ...
    begin
        ...
        commandtext:=commandtext+'  a.rec_id,a.parent_id,a.comp_id,a.mate_id,agent=dbo.fn_mate_name(a.mate_id),a.cate_id,a.med_id,a.bat_cd,a.qty,a.price,b.med_name,b.med_code,b.chm_name,b.specifi,b.pdt_place,';
