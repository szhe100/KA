...
begin
    ...
    commandtext:='select b.dtl_id,a.bod_id,a.bod_cd,a.bod_status_id,a.cate_id,d.med_code,d.material_code1,d.med_name,d.specifi,d.pdt_place,d.qtyperpack,'; //cdistrict=dbo.fn_getdistrict(j.district),';
