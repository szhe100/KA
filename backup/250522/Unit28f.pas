...
procedure Tpickchannel.Edit1KeyPress(Sender: TObject; var Key: Char);
var sk: widestring;
begin
    ...
    sk:=trim(edit1.text);
{
    ...
    begin
        ...
        commandtext:=commandtext+' obj_id,obj_code,zdesc,qry_code=dbo.fn_getpy(zdesc) from tb_object';
        commandtext:=commandtext+' where obj_type_id=11'; // comp_id='+inttostr(compid)+' and
...
procedure Tpickchannel.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickchannel.DBGrid1DblClick(Sender: TObject);
begin
   modalresult:=mrOK;
end;

procedure Tpickchannel.wwDBNavigator1FirstClick(Sender: TObject);
begin
edit1.setfocus;
end;

procedure Tpickchannel.FormCloseQuery(Sender: TObject;
...
procedure Tpickchannel.FormActivate(Sender: TObject);
var Key: Char;
begin
edit1.setfocus;
edit1.selectall;
...
procedure Tpickchannel.BitBtn3Click(Sender: TObject);
begin
self.tag:=1;  // <Esc> (cancel) 退出标志
end;

procedure Tpickchannel.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickchannel.DSquery1DataChange(Sender: TObject; Field: TField);
begin
if activecontrol=dbgrid1 then
edit1.text:=query1.fieldbyname('pick_ord').asstring;
end;

procedure Tpickchannel.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
