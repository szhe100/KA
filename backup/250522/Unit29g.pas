...
type
  Tsetreport10b = class(TForm)
    ...
    query1platform_id: TIntegerField;
    query1cplatform: TStringField;
    ...
    dxDBGrid2price1a: TdxDBGridColumn;
    dxDBGrid2Cprice_diff: TdxDBGridColumn;
...
procedure Tsetreport10b.FormCloseQuery(Sender: TObject;
...
procedure Tsetreport10b.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetreport10b.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetreport10b.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
with query1 do
...
procedure Tsetreport10b.FormCreate(Sender: TObject);
begin
...
procedure Tsetreport10b.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid2.SaveToXLS, self.tag);
end;

procedure Tsetreport10b.SpeedButton5Click(Sender: TObject);
var mi: integer;
begin
...
//        commandtext:='select a.rec_id,a.ckd_amot3,y.* from tb_bill_stadtl a inner join (select h.rec_id,b.dtl_id,a.bod_id,a.bod_type_id,a.busi_type,a.bod_cd,creat_dt=cast(convert(char(10),a.carry_dt,20) as datetime),a.bod_desc,';
        commandtext:='select a.rec_id,a.ckd_amot3,y.* from tb_bill_stadtl a inner join (select h.rec_id,b.dtl_id,a.bod_id,a.bod_type_id,a.busi_type,a.bod_cd,creat_dt=cast(convert(char(10),a.carry_dt,20) as datetime),a.bod_desc,';
		commandtext:=commandtext+' a.platform_id,d.type_id2,d.price1,';
        ...
        commandtext:=commandtext+' broker=c.zname,cdistrict=dbo.fn_getdistrict(e.district),receiver1=c.receiver,c.bank_name,c.depo_acco,';
//        commandtext:=commandtext+' broker=c.zname,cdistrict=dbo.fn_getdistrict(c.district),receiver1=c.receiver,c.bank_name,c.depo_acco,';
        ...
        commandtext:=commandtext+' left join (select rec_id,type_id2,price1 from tb_brokermed) d on b.rule_id=d.rec_id';
        ...
        if Trim(dxLookupTreeView1.text)<>'' then commandtext:=commandtext+' and dbo.fn_treeischild(e.district,'+DM.district.fieldbyname('rec_id').asstring+')>0 ';
{
		...
		commandtext:=commandtext+' a.platform_id,type_id2=0,price1=0,'; //dbo.fn_getmatemedcateid(a.comp_id,a.src_id,b.med_id),';
        ...
        commandtext:=commandtext+' bat_cd='''',amot=cast(a.bod_amot as decimal(15,2)),qty=0,rate=0,h.rate1,h.rate2,y.ckd_amot,j.amot1,j.amot2,h.ckd_amot3';
...
procedure Tsetreport10b.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetreport10b.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetreport10b.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbroker do
...
procedure Tsetreport10b.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetreport10b.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetreport10b.MenuItem1Click(Sender: TObject);
...
if mi=0 then raise Exception.Create('无可生成记录(已生成的不可再次生成)');
...
procedure Tsetreport10b.MenuItem3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetreport10b.MenuItem5Click(Sender: TObject);
begin
with dxdbgrid2 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetreport10b.MenuItem6Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid2 do
...
procedure Tsetreport10b.MenuItem8Click(Sender: TObject);
begin
...
procedure Tsetreport10b.query1CalcFields(DataSet: TDataSet);
begin
with query1 do
begin
...
procedure Tsetreport10b.dxDBGrid2CustomDrawCell(Sender: TObject;
...
procedure Tsetreport10b.query1AfterPost(DataSet: TDataSet);
begin
...
procedure Tsetreport10b.dxDBGrid2leaderButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
...
procedure Tsetreport10b.dxDBGrid2Click(Sender: TObject);
var amt: real;
    i,p: integer;
begin
with dxDBGrid2 do
...
procedure Tsetreport10b.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetreport10b.dxDBGrid2SelectedCountChange(Sender: TObject);
var amt: real;
    i,p: integer;
begin
with dxDBGrid2 do
...
procedure Tsetreport10b.dxDateEdit1DblClick(Sender: TObject);
...
procedure Tsetreport10b.dxDateEdit2DblClick(Sender: TObject);
var Year, Month, Day: Word;
begin
//showmessage(datetostr(dxDateEdit1.date));
