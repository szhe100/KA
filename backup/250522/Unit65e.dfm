object settruststopapply1: Tsettruststopapply1
  Left = 191
  Top = 106
  AutoScroll = False
  Caption = #25176#31649#36153#35268#21017#20572#29992#19994#21153#23457#26680
  ClientHeight = 457
  ClientWidth = 754
  Color = clBtnFace
  ...
  object cdsbill: TClientDataSet
    ...
    object cdsbillallo_desc: TStringField
      FieldName = 'allo_desc'
    end
  ...
  object cdsbill_dtl: TClientDataSet
    ...
    object cdsbill_dtllevel_id: TWordField
      DisplayLabel = #32423#21035
      FieldName = 'level_id'
    end
    object cdsbill_dtlcdistrict: TStringField
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select b.bod_id,b.dtl_id,a.rec_id,a.mate_id,a.med_id,e.mate_name' +
        ',m.med_code,m.med_name,m.chm_name,m.specifi,m.pdt_place,'#9'e.distr' +
        'ict,cdistrict=dbo.fn_getdistrict(e.district),med_unit=dbo.fn_obj' +
        '_desc(m.unit_id),med_type=dbo.fn_med_type(m.med_id),m.qtyperpack' +
        ','#9'b.price1,b.price,b.rate,b.rela_value,b.cost,b.qty,a.level_id,a' +
        '.f1,a.f2,a.f3,a.f4,a.valid,a.valid_dt'#9'from tb_bill_dtl b,tb_sysr' +
        'ule a'#9'left join tb_busimate e on a.mate_id=e.mate_id'#9'left join t' +
        'b_medicine m on a.med_id=m.med_id'#9'where b.med_id=a.rec_id and b.' +
        'bod_id=21651')
    Left = 514
    Top = 211
    ...
    object ADOQuery1cdistrict: TStringField
      DisplayLabel = #25152#22312#22320#21306
      FieldName = 'cdistrict'
      Size = 100
    end
    ...
    object ADOQuery1med_type: TStringField
      DisplayLabel = #21058#22411
      FieldName = 'med_type'
      ReadOnly = True
      Size = 10
