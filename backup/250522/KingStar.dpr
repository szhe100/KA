...
uses
  ...
  Unit15g in 'Unit15g.pas' {setmedexport9},
  Unit15h in 'Unit15h.pas' {setmedexport10},
  Unit202o in 'Unit202o.pas' {qryclassexp6},
  ...
  Unit28f in 'Unit28f.pas' {pickchannel},
...
{$ENDIF}
  ...
  Application.CreateForm(Tpickchannel, pickchannel);
