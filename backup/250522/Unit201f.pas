...
type
  Tqryclassimp7 = class(TForm)
    ...
    dxDBGrid1KWMENG: TdxDBGridColumn;
    dxDBGrid1ZPR03: TdxDBGridColumn;
    dxDBGrid1ZKHJE: TdxDBGridColumn;
    dxDBGrid1ZKONV: TdxDBGridColumn;
    dxDBGrid1KZWI5: TdxDBGridColumn;
    dxDBGrid1ZREC: TdxDBGridColumn;
...
procedure Tqryclassimp7.FormCloseQuery(Sender: TObject;
...
procedure Tqryclassimp7.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryclassimp7.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryclassimp7.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
speedbutton2.enabled:=(qry.active) and (qry.recordcount>0);
end;

procedure Tqryclassimp7.FormCreate(Sender: TObject);
begin
...
procedure Tqryclassimp7.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tqryclassimp7.SpeedButton5Click(Sender: TObject);
var si: integer;
begin
...
begin
    ...
    commandtext:=commandtext+' where KDGRP in (''12'',''13'',''16'')';
...
procedure Tqryclassimp7.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassimp7.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryclassimp7.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tqryclassimp7.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tqryclassimp7.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tqryclassimp7.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tqryclassimp7.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tqryclassimp7.qryCalcFields(DataSet: TDataSet);
begin
{
with qry do
begin
...
procedure Tqryclassimp7.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tqryclassimp7.FormActivate(Sender: TObject);
begin
with dm.district do
