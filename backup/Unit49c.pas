...
type
  Tsetallotruleapply3 = class(TForm)
...
var
  setallotruleapply3: Tsetallotruleapply3;
...
procedure Tsetallotruleapply3.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetallotruleapply3.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetallotruleapply3.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetallotruleapply3.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotruleapply3.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotruleapply3.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotruleapply3.DSbill_dtlDataChange(Sender: TObject;
  Field: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotruleapply3.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetallotruleapply3.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=22 and a.bod_status_id in (1,4)'; // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetallotruleapply3.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotruleapply3.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetallotruleapply3.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotruleapply3.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotruleapply3.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetallotruleapply3.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetallotruleapply3.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetallotruleapply3.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetallotruleapply3.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetallotruleapply3.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetallotruleapply3.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetallotruleapply3.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotruleapply3.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotruleapply3.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotruleapply3.N1Click(Sender: TObject);
...
procedure Tsetallotruleapply3.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetallotruleapply3.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotruleapply3.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetallotruleapply3.brokermedtlCalcFields(DataSet: TDataSet);
begin
with brokermedtl do
begin
...
procedure Tsetallotruleapply3.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetallotruleapply3.SpeedButton6Click(Sender: TObject);
begin
...
procedure Tsetallotruleapply3.SpeedButton3Click(Sender: TObject);
begin
