...
procedure Tsetallotrule.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotrule.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tsetallotrule.DSsysruleDataChange(Sender: TObject;
  Field: TField);
begin
speedbutton2.enabled:=(sysrule.active=true) and (sysrule.recordcount>0);
end;

procedure Tsetallotrule.sysruleBeforeDelete(DataSet: TDataSet);
begin
...
procedure Tsetallotrule.sysruleAfterPost(DataSet: TDataSet);
begin
with sysrule do
...
procedure Tsetallotrule.SpeedButton3Click(Sender: TObject);
var mi: integer;
begin
with sysrule do
begin
    ...
    commandtext:=commandtext+'	where a.type_id=3 and a.comp_id='+inttostr(compid);
...
procedure Tsetallotrule.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotrule.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetallotrule.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotrule.dxDBGrid1lead_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickstaff do
begin
...
procedure Tsetallotrule.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotrule.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotrule.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetallotrule.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tsetallotrule.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tsetallotrule.dxDBGrid1mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbusimate2 do
begin
...
procedure Tsetallotrule.dxDBGrid1med_codeButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickmedicine do
begin
...
procedure Tsetallotrule.dxDBGrid1Enter(Sender: TObject);
begin
with sysrule do
    if (active=true) and (recordcount=0) then append;
end;

procedure Tsetallotrule.sysruleBeforePost(DataSet: TDataSet);
begin
with sysrule do
...
procedure Tsetallotrule.SpeedButton4Click(Sender: TObject);
var mi: integer;
...
begin
    if active=true then close;
    commandtext:='select top 1 1 from tb_sysrule where type_id=3 and valid=1 and comp_id='+inttostr(compid);
...
procedure Tsetallotrule.N7Click(Sender: TObject);
...
procedure Tsetallotrule.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbusimate2 do
begin
...
procedure Tsetallotrule.sysruleBeforeEdit(DataSet: TDataSet);
begin
if sysrule.fieldbyname('valid').asboolean=True then raise Exception.Create('本规则已启用，不可更改');
end;

procedure Tsetallotrule.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotrule.sysrulef4Change(Sender: TField);
begin
with sysrule do
begin
...
procedure Tsetallotrule.MenuItem3Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetallotrule.N1Click(Sender: TObject);
var i,mi,l,m,n,k,o,p,q,i1,i2,m1,m2,m3: integer;
    s,t: string;
    mcd: string[20];
begin
...
procedure Tsetallotrule.SpeedButton5Click(Sender: TObject);
begin
with sysrule do
...
procedure Tsetallotrule.FormActivate(Sender: TObject);
begin
with price_type do
begin
