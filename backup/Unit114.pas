...
procedure Tqryreport16.FormCloseQuery(Sender: TObject;
...
procedure Tqryreport16.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tqryreport16.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tqryreport16.DSdrawlogDataChange(Sender: TObject;
  Field: TField);
begin
speedbutton2.enabled:=(qry.active=true) and (qry.recordcount>0);
end;

procedure Tqryreport16.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tqryreport16.SpeedButton5Click(Sender: TObject);
var mi: integer;
begin
with qry do
begin
...
procedure Tqryreport16.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tqryreport16.FormActivate(Sender: TObject);
begin
//with dm.district do
//    if active=false then open;
end;

procedure Tqryreport16.qryCalcFields(DataSet: TDataSet);
begin
with qry do
begin
...
procedure Tqryreport16.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tqryreport16.dxDBGrid1DblClick(Sender: TObject);
begin
...
procedure Tqryreport16.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
    if showmodal= mrOK then
...
procedure Tqryreport16.dxDBGrid1CustomDrawFooter(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
