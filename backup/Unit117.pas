...
//edit5.Text:=commandtext;
    ...
    if active=True then close;
	commandtext:='select top 3 m.med_code,m.material_code1,m.med_name,m.specifi,m.pdt_place,c.bat_cd from (';
...
{
    commandtext:='select top 3 b.med_id,b.rela_id1,m.med_code,m.med_name,m.material_code1,m.specifi,m.pdt_place,b.bat_cd,qty1=sum(isnull(qty1,0)),qty=sum(qty)';   //b.bat_cd,
