...
var
  setmedexport10: Tsetmedexport10;
  ptype: string[20];
  pcent: real;
...
procedure Tsetmedexport10.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetmedexport10.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetmedexport10.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetmedexport10.FormCloseQuery(Sender: TObject;
...
procedure Tsetmedexport10.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetmedexport10.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetmedexport10.dxDBGrid2KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
...
procedure Tsetmedexport10.DSbill_dtlDataChange(Sender: TObject;
  Field: TField);
begin
exit;
...
procedure Tsetmedexport10.dxDBGrid2Enter(Sender: TObject);
begin
...
procedure Tsetmedexport10.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetmedexport10.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetmedexport10.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetmedexport10.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
//    commandtext:=commandtext+' platform_id=dbo.fn_getdtlplatformid(a.bod_id)';
    ...
    commandtext:=commandtext+' where a.bod_type_id=2 and a.cate_id=7';  // cate_id 1:商业 2:分销 3:终端战略 4:终端普通 5:两票商业 6:连锁终端销售出库单 7:零售销售出库单
...
procedure Tsetmedexport10.FormCreate(Sender: TObject);
begin
...
procedure Tsetmedexport10.SpeedButton6Click(Sender: TObject);
var mid : integer;
begin
...
begin
    ...
    commandtext:=commandtext+' values ('+inttostr(compid)+',2,0,7,1,'+inttostr(curuserid)+',getdate(),cast(convert(char(10),getdate(),20) as datetime))';
...
procedure Tsetmedexport10.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetmedexport10.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetmedexport10.Edit1KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
    fwid: boolean; //  东方语言 宽字符 (2bytes)
...
procedure Tsetmedexport10.Edit1Click(Sender: TObject);
begin
(sender as TEdit).selectall;
end;

procedure Tsetmedexport10.dxDBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var fapp: boolean;
begin
...
procedure Tsetmedexport10.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetmedexport10.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetmedexport10.SpeedButton2Click(Sender: TObject);
var s: string;
begin
with cdsbill do
begin
...
procedure Tsetmedexport10.SpeedButton4Click(Sender: TObject);
begin
...
procedure Tsetmedexport10.SpeedButton3Click(Sender: TObject);
var s: string;
begin
with dm.pubqry do
begin
...
procedure Tsetmedexport10.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetmedexport10.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetmedexport10.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetmedexport10.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
    then raise Exception.Create('本单已审核，不可更改。'+#13#10+'如需更改，请先反审核');
...
procedure Tsetmedexport10.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetmedexport10.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetmedexport10.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetmedexport10.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
    fieldbyname('amot').asfloat:=round(fieldbyname('price').asfloat*fieldbyname('qty').asfloat*100+0.01)/100;
end;

procedure Tsetmedexport10.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetmedexport10.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetmedexport10.dxDBGrid2DblClick(Sender: TObject);
var key:char;
begin
exit;
key:=#32;
...
procedure Tsetmedexport10.Edit2KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
    fwid: boolean; //  东方语言 宽字符 (2bytes)
...
procedure Tsetmedexport10.SpeedButton1Click(Sender: TObject);
var
    XL,Sheet: Variant;
...
procedure Tsetmedexport10.N1Click(Sender: TObject);
...
procedure Tsetmedexport10.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure Tsetmedexport10.N3Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t : string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
...
procedure Tsetmedexport10.dxDBButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetmedexport10.dxDBButtonEdit3Enter(Sender: TObject);
begin
(Sender as TdxDBButtonEdit).SelectAll;
end;

procedure Tsetmedexport10.dxDBButtonEdit3KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if (key=VK_RETURN) and (Shift=[ssCtrl]) then (Sender as TdxDBButtonEdit).OnButtonClick(nil,0);
end;

procedure Tsetmedexport10.dxDBButtonEdit3KeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tsetmedexport10.Button1Click(Sender: TObject);
begin
...
procedure Tsetmedexport10.N5Click(Sender: TObject);
begin
...
procedure Tsetmedexport10.dxEdit1Click(Sender: TObject);
begin
dxEdit1.SelectAll;
dxEdit1.SetFocus;
end;

procedure Tsetmedexport10.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetmedexport10.N6Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'列表1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tsetmedexport10.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
	case fieldbyname('platform_id').asinteger of
...
procedure Tsetmedexport10.N9Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t : string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
