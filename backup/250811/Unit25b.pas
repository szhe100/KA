...
procedure Tsetcheckstock2.BitBtn1Click(Sender: TObject);
begin
with cdsbill do
...
procedure Tsetcheckstock2.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetcheckstock2.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
begin
    ...
    commandtext:=commandtext+'select @@identity';     //busi_type: 1 商业公司盘点单；2 连锁终端盘点单
    open;
...
procedure Tsetcheckstock2.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetcheckstock2.Edit1KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
    fwid: boolean; //  东方语言 宽字符 (2bytes)
...
procedure Tsetcheckstock2.Edit1Click(Sender: TObject);
begin
edit1.selectall;
end;
...
procedure Tsetcheckstock2.dxDBGrid2DblClick(Sender: TObject);
begin
...
procedure Tsetcheckstock2.N3Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t : string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
...
procedure Tsetcheckstock2.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickmedicine do
    if showmodal= mrOK then
