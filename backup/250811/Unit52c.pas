...
var
  setmedistprice1: Tsetmedistprice1;
...
procedure Tsetmedistprice1.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetmedistprice1.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag)
end;

procedure Tsetmedistprice1.DSmedataDataChange(Sender: TObject;
  Field: TField);
begin
with medata do
begin
...
procedure Tsetmedistprice1.SpeedButton4Click(Sender: TObject);
var mi: integer;
begin
...
procedure Tsetmedistprice1.medataBeforeDelete(DataSet: TDataSet);
begin
...
procedure Tsetmedistprice1.medataAfterPost(DataSet: TDataSet);
begin
if medata.ChangeCount>0 then myupdaterefresh(medata,'tb_medata','rec_id','');
end;

procedure Tsetmedistprice1.SpeedButton3Click(Sender: TObject);
var mi: integer;
begin
with medata do
begin
...
procedure Tsetmedistprice1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetmedistprice1.medataReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetmedistprice1.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetmedistprice1.FormCloseQuery(Sender: TObject;
...
procedure Tsetmedistprice1.FormCreate(Sender: TObject);
begin
...
procedure Tsetmedistprice1.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetmedistprice1.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetmedistprice1.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tsetmedistprice1.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tsetmedistprice1.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetmedistprice1.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetmedistprice1.medataCalcFields(DataSet: TDataSet);
begin
with medata do
    if fieldbyname('price4').asfloat<>0 then fieldbyname('crate').asfloat:= 100*fieldbyname('rate').asfloat/ fieldbyname('price4').asfloat
    else if fieldbyname('price').asfloat<>0 then fieldbyname('crate').asfloat:= 100*fieldbyname('rate').asfloat/ fieldbyname('price').asfloat;
{
...
procedure Tsetmedistprice1.medataBeforePost(DataSet: TDataSet);
begin
{
with medata do
begin
...
procedure Tsetmedistprice1.SpeedButton6Click(Sender: TObject);
var
    XL,Sheet: Variant;
