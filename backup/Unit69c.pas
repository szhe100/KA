...
type
  Tsettrustfeeapply3 = class(TForm)
...
var
  settrustfeeapply3: Tsettrustfeeapply3;
...
procedure Tsettrustfeeapply3.setupdatestatus;    // 编辑状态
begin
...
procedure Tsettrustfeeapply3.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsettrustfeeapply3.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsettrustfeeapply3.FormCloseQuery(Sender: TObject;
...
procedure Tsettrustfeeapply3.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsettrustfeeapply3.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsettrustfeeapply3.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsettrustfeeapply3.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsettrustfeeapply3.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsettrustfeeapply3.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
procedure Tsettrustfeeapply3.FormCreate(Sender: TObject);
begin
...
procedure Tsettrustfeeapply3.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsettrustfeeapply3.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsettrustfeeapply3.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsettrustfeeapply3.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsettrustfeeapply3.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsettrustfeeapply3.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsettrustfeeapply3.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsettrustfeeapply3.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsettrustfeeapply3.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsettrustfeeapply3.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsettrustfeeapply3.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsettrustfeeapply3.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsettrustfeeapply3.N1Click(Sender: TObject);
...
procedure Tsettrustfeeapply3.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsettrustfeeapply3.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsettrustfeeapply3.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
...
procedure Tsettrustfeeapply3.SpeedButton6Click(Sender: TObject);
begin
...
procedure Tsettrustfeeapply3.SpeedButton2Click(Sender: TObject);
begin
...
begin
    if active=true then close;
    commandtext:='sp_updatestock16 16,'+cdsbill.fieldbyname('bod_id').asstring+','+inttostr(curuserid);
    execute;
    close;
end;
...
procedure Tsettrustfeeapply3.SpeedButton3Click(Sender: TObject);
begin
