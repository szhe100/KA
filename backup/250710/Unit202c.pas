...
begin
    ...
    commandtext:=commandtext+' b.dtl_id,a.bod_cd,a.bod_status_id,d.material_code,d.med_code,d.med_name,d.specifi,d.pdt_place,d.qtyperpack,cdistrict=dbo.fn_getdistrict1(j.district),';
    ...
    commandtext:=commandtext+' dist1=dbo.fn_getdistrictname(j.district,1),';
    commandtext:=commandtext+' dist2=dbo.fn_getdistrictname(j.district,2),';
...
procedure Tqryclassexp3.dxLookupTreeView1DropDown(Sender: TObject);
begin
setprogress(1);
end;

procedure Tqryclassexp3.dxLookupTreeView1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
setprogress(0);
end;
