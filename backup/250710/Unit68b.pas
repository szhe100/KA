...
type
  Tsetallotfeeapply2 = class(TForm)
...
var
  setallotfeeapply2: Tsetallotfeeapply2;
...
procedure Tsetallotfeeapply2.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetallotfeeapply2.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetallotfeeapply2.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetallotfeeapply2.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotfeeapply2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotfeeapply2.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply2.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetallotfeeapply2.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetallotfeeapply2.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetallotfeeapply2.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=15 and a.bod_status_id in (1,3,4)';  // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetallotfeeapply2.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotfeeapply2.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply2.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetallotfeeapply2.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply2.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply2.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply2.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetallotfeeapply2.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetallotfeeapply2.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetallotfeeapply2.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetallotfeeapply2.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetallotfeeapply2.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetallotfeeapply2.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotfeeapply2.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply2.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotfeeapply2.N1Click(Sender: TObject);
...
procedure Tsetallotfeeapply2.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetallotfeeapply2.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotfeeapply2.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
...
procedure Tsetallotfeeapply2.SpeedButton6Click(Sender: TObject);
begin
