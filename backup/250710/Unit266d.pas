...
begin
    ...
    commandtext:=commandtext+' b.amot,b.fee,b.rate,a.*,broker='''',c.mate_name,agent=d.mate_name,m.med_code,m.med_name,m.chm_name,m.specifi,med_unit=dbo.fn_obj_desc(m.unit_id),m.qtyperpack,'; //pdt_place=dbo.fn_mate_name(m.pdt_id),
