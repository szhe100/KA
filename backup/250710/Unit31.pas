...
var
  pickbusimate10: Tpickbusimate10;
...
procedure Tpickbusimate10.Edit1KeyPress(Sender: TObject; var Key: Char);
var sc: string;
    mi: integer;
    sk: widestring;
    fwid: boolean;
...
begin
    ...
    begin
        ...
        commandtext:=commandtext+' where mate_type_id=10'; // and comp_id='+inttostr(compid);
...
//         else commandtext:=commandtext+' and qry_code like''%'+sk+'%''';
        open;
        if recordcount=0 then begin beep; raise Exception.Create('无所查询推广服务商'); end;
    end;
end;
end;

procedure Tpickbusimate10.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickbusimate10.DBGrid1DblClick(Sender: TObject);
begin
   modalresult:=mrOK;
end;

procedure Tpickbusimate10.wwDBNavigator1FirstClick(Sender: TObject);
begin
edit1.setfocus;
end;

procedure Tpickbusimate10.FormCloseQuery(Sender: TObject;
...
procedure Tpickbusimate10.FormActivate(Sender: TObject);
begin
edit1.setfocus;
edit1.selectall;
end;

procedure Tpickbusimate10.BitBtn3Click(Sender: TObject);
begin
self.tag:=1;  // <Esc> (cancel) 退出标志
end;

procedure Tpickbusimate10.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tpickbusimate10.DSquery1DataChange(Sender: TObject; Field: TField);
begin
if activecontrol=dbgrid1 then
edit1.text:=query1.fieldbyname('pick_ord').asstring;
end;

procedure Tpickbusimate10.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
