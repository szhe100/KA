...
var
  setallotfeeapply: Tsetallotfeeapply;
...
procedure Tsetallotfeeapply.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetallotfeeapply.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetallotfeeapply.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetallotfeeapply.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotfeeapply.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotfeeapply.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetallotfeeapply.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetallotfeeapply.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetallotfeeapply.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=15';   // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetallotfeeapply.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotfeeapply.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetallotfeeapply.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply.SpeedButton2Click(Sender: TObject);
var s: string;
begin
{
with cdsbill do
...
procedure Tsetallotfeeapply.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetallotfeeapply.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetallotfeeapply.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetallotfeeapply.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetallotfeeapply.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetallotfeeapply.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetallotfeeapply.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotfeeapply.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotfeeapply.N1Click(Sender: TObject);
...
procedure Tsetallotfeeapply.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetallotfeeapply.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotfeeapply.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
