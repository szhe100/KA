...
//            commandtext:='select top 1 rec_id from tb_treedata where dbo.fn_getdistrict(rec_id)='''+s3+'''';
            ...
            commandtext:=commandtext+' else insert into tb_busimate (mate_code,mate_name,district,region,qry_code,mate_type_id,zname1,address1,phone1,zname2,address2,phone2,creat_by,creat_dt)';
