...
procedure Tsetexpaycash1.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetexpaycash1.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetexpaycash1.FormActivate(Sender: TObject);
begin
with homebank do
...
procedure Tsetexpaycash1.FormCloseQuery(Sender: TObject;
...
procedure Tsetexpaycash1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetexpaycash1.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetexpaycash1.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetexpaycash1.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
procedure Tsetexpaycash1.FormCreate(Sender: TObject);
begin
...
procedure Tsetexpaycash1.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsetexpaycash1.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetexpaycash1.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetexpaycash1.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetexpaycash1.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetexpaycash1.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetexpaycash1.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetexpaycash1.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetexpaycash1.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetexpaycash1.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetexpaycash1.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetexpaycash1.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetexpaycash1.N1Click(Sender: TObject);
...
procedure Tsetexpaycash1.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure Tsetexpaycash1.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetexpaycash1.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetexpaycash1.SpeedButton3Click(Sender: TObject);
begin
...
procedure Tsetexpaycash1.SpeedButton6Click(Sender: TObject);
begin
