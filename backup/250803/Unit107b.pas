...
procedure TsetexpaycashB.setupdatestatus;    // 编辑状态
begin
...
procedure TsetexpaycashB.setunupdatestatus;  // 浏览状态
begin
...
procedure TsetexpaycashB.FormActivate(Sender: TObject);
begin
{
with homebank do
...
procedure TsetexpaycashB.FormCloseQuery(Sender: TObject;
...
procedure TsetexpaycashB.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TsetexpaycashB.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure TsetexpaycashB.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TsetexpaycashB.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure TsetexpaycashB.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure TsetexpaycashB.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
procedure TsetexpaycashB.FormCreate(Sender: TObject);
begin
...
procedure TsetexpaycashB.SpeedButton7Click(Sender: TObject);
begin
...
procedure TsetexpaycashB.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure TsetexpaycashB.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure TsetexpaycashB.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure TsetexpaycashB.SpeedButton2Click(Sender: TObject);
//var s: string;
begin
{
with cdsbill do
...
procedure TsetexpaycashB.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure TsetexpaycashB.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure TsetexpaycashB.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure TsetexpaycashB.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure TsetexpaycashB.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure TsetexpaycashB.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure TsetexpaycashB.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure TsetexpaycashB.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure TsetexpaycashB.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure TsetexpaycashB.N1Click(Sender: TObject);
...
procedure TsetexpaycashB.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure TsetexpaycashB.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure TsetexpaycashB.dxDBButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbank do
begin
...
procedure TsetexpaycashB.dxDBButtonEdit3Enter(Sender: TObject);
begin
(Sender as TdxDBButtonEdit).SelectAll;
end;

procedure TsetexpaycashB.dxDBButtonEdit3KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if (key=VK_RETURN) and (Shift=[ssCtrl]) then (Sender as TdxDBButtonEdit).OnButtonClick(nil,0);
end;

procedure TsetexpaycashB.dxDBButtonEdit3KeyPress(Sender: TObject;
  var Key: Char);
begin
