...
type
  Tqryclassexp5 = class(TForm)
    ...
    dxDBGrid2Csubbusi: TdxDBGridColumn;
...
begin
    ...
    commandtext:=commandtext+' med_unit=dbo.fn_obj_desc(d.unit_id),a.bod_desc,supplier=l.mate_name,customer=dbo.fn_mate_name(a.dst_id),agent=dbo.fn_mate_name(a.src_id),';
    ...
    commandtext:=commandtext+' a.sub_busi_id,leader=dbo.fn_staff_name(b.lead_id),broker=dbo.fn_mate_name(a.agent_id),';
...
//    commandtext:=commandtext+' left join tb_busiframe1 k on b.med_id=k.med_id and dbo.fn_ischildnode(j.district,k.district_id)=1'; //b.lead_id=k.sta_id and
    ...
    commandtext:=commandtext+' where a.bod_type_id=2 and a.cate_id=4';  // and a.bod_status_id=1 a.comp_id='+inttostr(compid)+' and  and a.cate_id=2
