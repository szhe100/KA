...
type
  Tsetallotfeeapply3 = class(TForm)
...
var
  setallotfeeapply3: Tsetallotfeeapply3;
...
procedure Tsetallotfeeapply3.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetallotfeeapply3.setunupdatestatus;  // 浏览状态
begin
speedbutton5.enabled:=true;   // refresh enable
end;

procedure Tsetallotfeeapply3.FormActivate(Sender: TObject);
begin
if cdsbill.active=False then SpeedButton5Click(nil);
end;

procedure Tsetallotfeeapply3.FormCloseQuery(Sender: TObject;
...
procedure Tsetallotfeeapply3.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetallotfeeapply3.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply3.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetallotfeeapply3.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetallotfeeapply3.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetallotfeeapply3.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=15 and a.bod_status_id in (1,4)'; // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetallotfeeapply3.FormCreate(Sender: TObject);
begin
...
procedure Tsetallotfeeapply3.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply3.DSbillDataChange(Sender: TObject; Field: TField);
begin
    ...
    with cdsbill_dtl do
        if tag<>cdsbill.fieldbyname('bod_id').asinteger then
            ...
            begin
                ...
                commandtext:=commandtext+' from tb_bill_dtl b,tb_bill c,tb_bill_dtl d';
                commandtext:=commandtext+' where b.med_id=d.dtl_id and c.bod_id=d.bod_id and b.bod_id='+cdsbill.fieldbyname('bod_id').asstring;
edit1.text:=commandtext;
                try
                    setprogress(1);
                    open;
...
procedure Tsetallotfeeapply3.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply3.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetallotfeeapply3.SpeedButton2Click(Sender: TObject);
begin
...
begin
    if active=true then close;
    commandtext:='sp_updatestock15 15,'+cdsbill.fieldbyname('bod_id').asstring+','+inttostr(curuserid);
    execute;
    close;
end;
...
procedure Tsetallotfeeapply3.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetallotfeeapply3.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetallotfeeapply3.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetallotfeeapply3.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsetallotfeeapply3.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetallotfeeapply3.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetallotfeeapply3.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetallotfeeapply3.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetallotfeeapply3.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetallotfeeapply3.N1Click(Sender: TObject);
...
procedure Tsetallotfeeapply3.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
try
...
procedure Tsetallotfeeapply3.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetallotfeeapply3.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
{
with cdsbill_dtl do
begin
...
procedure Tsetallotfeeapply3.SpeedButton6Click(Sender: TObject);
begin
...
procedure Tsetallotfeeapply3.SpeedButton3Click(Sender: TObject);
begin
