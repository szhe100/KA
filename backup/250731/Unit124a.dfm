object pickexpensesup: Tpickexpensesup
  Left = 212
  Top = 116
  ...
  AutoScroll = False
  BorderIcons = []
  Caption = #26597#35810#20250#35745#36153#29992#20379#24212#26041
  ClientHeight = 555
  ClientWidth = 541
  Color = clBtnFace
  ...
  object DBGrid1: TdxDBGrid
    ...
    object DBGrid1mate_name: TdxDBGridMaskColumn
      Caption = #20379#24212#26041#21517#31216
      Font.Charset = GB2312_CHARSET
      Font.Color = clNavy
      Font.Height = -12
      Font.Name = #23435#20307
    ...
    object DBGrid1cdistrict: TdxDBGridColumn
      Width = 80
      BandIndex = 0
      RowIndex = 0
      FieldName = 'cdistrict'
  ...
  object query1: TClientDataSet
    Aggregates = <>
    CommandText = 
      'select mate_code,pick_ord,mate_id,mate_name,deputy,phone,address' +
      ',broker,settle_type,stop_yn,qry_code from tb_busimate'
    PacketRecords = 20
    Params = <>
    ...
    object query1mate_code: TStringField
      FieldName = 'mate_code'
      FixedChar = True
    end
    ...
    object query1district: TIntegerField
      DisplayLabel = #25152#22312#21306#22495
      FieldName = 'district'
    end
    object query1cdistrict: TStringField
    ...
    object query1settle_type_id: TIntegerField
      FieldName = 'settle_type_id'
    end
    object query1mate_type_id: TIntegerField
      FieldName = 'mate_type_id'
    end
    object query1license_cd: TStringField
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select top 1 pick_ord,mate_id,mate_code,mate_name,mate_type_id,m' +
        'ate_type=case mate_type_id when 1 then '#39#20379#24212#21830#39' when 2 then '#39#38144#21806#23458#25143#39' ' +
        'when 3 then '#39#29983#20135#20225#19994#39' end,'
      
        ' deputy,phone,address,settle_type_id,stop_yn,qry_code,license_cd' +
        ','
      ' broker=dbo.fn_staff_name(dbo.fn_getbrokeridbymateid(mate_id)),'
      ' broker_id=dbo.fn_getbrokeridbymateid(mate_id),broker_id1'
      ' from tb_busimate'
      
        ' where mate_type_id in (1,2,3) and comp_id=2 and qry_code like '#39 +
        '%s%'#39)
    Left = 377
    Top = 195
    ...
    object ADOQuery1mate_id: TAutoIncField
      FieldName = 'mate_id'
      ReadOnly = True
    end
    ...
    object ADOQuery1deputy: TStringField
      FieldName = 'deputy'
    end
    ...
    object ADOQuery1address: TStringField
      FieldName = 'address'
      Size = 100
    end
    object ADOQuery1settle_type_id: TIntegerField
      FieldName = 'settle_type_id'
    end
    ...
    object ADOQuery1broker_id: TStringField
      FieldName = 'broker_id'
      ReadOnly = True
      Size = 100
    end
    object ADOQuery1broker_id1: TIntegerField
      FieldName = 'broker_id1'
    end
    object ADOQuery1mate_type_id: TIntegerField
      FieldName = 'mate_type_id'
    end
    object ADOQuery1mate_type: TStringField
      FieldName = 'mate_type'
      ReadOnly = True
      Size = 8
    end
    object ADOQuery1license_cd: TStringField
      FieldName = 'license_cd'
      Size = 50
    end
  end
