    ...
    sk:=Trim(edit1.text);
{
    ...
    begin
        ...
        commandtext:=commandtext+' from tb_medicine a where 1=1'; // a.comp_id='+inttostr(compid);
{
        if fwid  // 宽字符串
...
//        commandtext:=commandtext+' and (a.med_code='''+sk+''' or a.med_code='''+sk+''' or a.med_code='''+sk+''' or a.material_code='''+sk+''' or a.material_code1='''+sk+''' or a.qry_code like''%'+sk+'%'' or a.med_name like''%'+sk+'%'' or a.chm_name like''%'+sk+'%'' or a.pdt_place like''%'+sk+'%'')';
        commandtext:=commandtext+' and (a.med_code='''+sk+''' or a.material_code='''+sk+''' or a.material_code1='''+sk+''' or a.qry_code like''%'+sk+'%'' or dbo.fn_getpy(a.med_name) like''%'+sk+'%'' or a.med_name like''%'+sk+'%'' or a.chm_name like''%'+sk+'%'' or a.pdt_place like''%'+sk+'%'')';
