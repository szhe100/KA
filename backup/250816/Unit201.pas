    ...
    else si:=0;
{
    ...
    commandtext:=commandtext+'  else cast(isnull(KONV,0) as decimal(15,4)) end as decimal(15,4)),a.*';
    ...
    commandtext:=commandtext+' a.ZCOUNTRY,a.ZREGIO,a.ZZREGION,a.ZCITYNUM,ZCITYNAME,a.VKORG,ZVKORG, KUNNR,NAME1,ASSIGNED_BP,NAME_FIRST,VBELN,GBELN,LPOSNR,BOLNR,';
...
//    if Trim(dxbuttonedit2.text)<>'' then commandtext:=commandtext+' and a.MATNR=(select top 1 material_code from tb_medicine where med_id='+inttostr(dxbuttonedit2.tag)+')';
    ...
    commandtext:=commandtext+' MATNR=m.material_code1,ARKTX=m.med_name,ZGG=m.specifi,ZSCQY=m.pdt_place,CHARG=b.bat_cd,VFDAT=convert(char(10),b.valid_dt,20),';
    ...
    commandtext:=commandtext+' ZREC=''0.00'',amot2=cast(b.price1*b.qty as decimal(15,2)),amot=cast(b.amot as decimal(15,2)),amot1=cast(b.amot1 as decimal(15,2)),rprice1=0.0000,rprice=0.0000,';
//    commandtext:=commandtext+' ZREC=''0.00'',amot2=cast(b.amot2 as decimal(15,2)),amot=cast(b.amot as decimal(15,2)),amot1=cast(b.amot1 as decimal(15,2)),rprice1=0.0000,rprice=0.0000,';
...
procedure Tqryclassimp.dxLookupTreeView1DropDown(Sender: TObject);
begin
setprogress(1);
end;

procedure Tqryclassimp.dxLookupTreeView1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
setprogress(0);
end;
