...
var
  setbusiframe10: Tsetbusiframe10;
...
procedure Tsetbusiframe10.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetbusiframe10.SpeedButton2Click(Sender: TObject);
begin
dm.Save1('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', self.caption+'1.xls', dxDBGrid1.SaveToXLS, self.tag);
end;

procedure Tsetbusiframe10.DSbusiframeDataChange(Sender: TObject;
  Field: TField);
begin
with busiframe do
begin
...
procedure Tsetbusiframe10.SpeedButton4Click(Sender: TObject);
var mi: integer;
begin
...
procedure Tsetbusiframe10.FormCloseQuery(Sender: TObject;
...
procedure Tsetbusiframe10.busiframeBeforeDelete(DataSet: TDataSet);
begin
...
procedure Tsetbusiframe10.SpeedButton3Click(Sender: TObject);
var mi: integer;
begin
with busiframe do
begin
...
procedure Tsetbusiframe10.busiframeBeforePost(DataSet: TDataSet);
begin
...
procedure Tsetbusiframe10.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetbusiframe10.FormActivate(Sender: TObject);
begin
{
with type1 do
...
procedure Tsetbusiframe10.FormCreate(Sender: TObject);
begin
...
procedure Tsetbusiframe10.dxButtonEdit2ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbroker do
    if showmodal= mrOK then
...
procedure Tsetbusiframe10.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetbusiframe10.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetbusiframe10.dxButtonEdit3ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
    if showmodal= mrOK then
...
procedure Tsetbusiframe10.busiframeAfterPost(DataSet: TDataSet);
begin
if busiframe.ChangeCount>0 then myupdaterefresh(busiframe,'tb_busiframe3','rec_id','');
end;

procedure Tsetbusiframe10.SpeedButton1Click(Sender: TObject);
begin
with dm.pubqry do
begin
    if active then close;
...
procedure Tsetbusiframe10.SpeedButton6Click(Sender: TObject);
var
    XL,Sheet: Variant;
...
procedure Tsetbusiframe10.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetbusiframe10.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetbusiframe10.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetbusiframe10.N2Click(Sender: TObject);
var i,mi: integer;
begin
with dxdbgrid1 do
begin
...
procedure Tsetbusiframe10.N6Click(Sender: TObject);
begin
...
procedure Tsetbusiframe10.N7Click(Sender: TObject);
...
procedure Tsetbusiframe10.busiframeCalcFields(DataSet: TDataSet);
begin
with busiframe do
...
procedure Tsetbusiframe10.busiframeBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetbusiframe10.dxButtonEdit5ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
    if showmodal= mrOK then
...
procedure Tsetbusiframe10.SpeedButton5Click(Sender: TObject);
var mi: integer;
begin
with busiframe do
begin
...
procedure Tsetbusiframe10.dtlCalcFields(DataSet: TDataSet);
begin
...
procedure Tsetbusiframe10.dtlBeforePost(DataSet: TDataSet);
begin
with dtl do
begin
...
procedure Tsetbusiframe10.dtlBeforeDelete(DataSet: TDataSet);
begin
with dm.pubqry do
begin
    if active then close;
...
procedure Tsetbusiframe10.dtlAfterPost(DataSet: TDataSet);
begin
...
procedure Tsetbusiframe10.N9Click(Sender: TObject);
