...
procedure Tsetreport26a.FormCloseQuery(Sender: TObject;
...
procedure Tsetreport26a.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetreport26a.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetreport26a.DSqryDataChange(Sender: TObject;
  Field: TField);
begin
with qry do
begin
...
procedure Tsetreport26a.FormCreate(Sender: TObject);
begin
...
procedure Tsetreport26a.SpeedButton2Click(Sender: TObject);
begin
...
procedure Tsetreport26a.SpeedButton5Click(Sender: TObject);
var mi: integer;
begin
...
begin
    ...
    begin
        ...
        commandtext:='select creat_dt=cast(convert(char(10),a.creat_dt,20) as datetime),j.carry_dt,check_dt1=j.check_dt,a.*,bod_cd1=j.bod_cd,b.mate_name,mate_name1=c.mate_name,creater=d.zname,checker=e.zname,';
        ...
        commandtext:=commandtext+' cdistrict=dbo.fn_getdistrict(c.district),cdistrict1=dbo.fn_getdistrict(k.district),f.bank_name,depo_acco=f.bank_acnt,j.bank_id1,j.bank_name1'; //=dbo.fn_bank_name(j.bank_id1)';
...
//        commandtext:=commandtext+' left join tb_staff f on a.broker_id =f.sta_id';
        ...
        commandtext:=commandtext+' left join (select bod_id,bod_cd,bank_id1=bank_id,bank_name1=dbo.fn_bank_name(bank_id),carry_dt,check_dt from tb_bill) j on j.bod_id=dbo.fn_getbodid(a.bod_id)';
...
with qry1 do
    begin
        ...
        commandtext:=commandtext+' cdistrict=dbo.fn_getdistrict(n.district),f.bank_name,depo_acco=f.bank_acnt,j.bank_id1,j.bank_name1,y.*,';   //=dbo.fn_bank_name(j.bank_id1)
        commandtext:=commandtext+' dist1=dbo.fn_getdistrictname(n.district,1),';
        commandtext:=commandtext+' dist2=dbo.fn_getdistrictname(n.district,2),';
...
//        commandtext:=commandtext+' left join (select a.bod_id,a.bod_cd,bank_id1=a.bank_id,a.carry_dt,a.check_dt from tb_bill a where bod_type_id=30 and bod_status_id=1) j on j.bod_id=dbo.fn_getbodid(a.bod_id)';
        ...
        //commandtext:=commandtext+' left join (select b.bod_id,bod_cd2=c.bod_cd,c.qty,b.price,b.amot,carry_dt1=c.carry_dt,c.med_id,c.med_code,c.med_name,c.specifi,c.pdt_place,c.med_unit';
        //commandtext:=commandtext+' from tb_bill_dtl b,vi_boddtlmed c where b.bod_id=c.bod_id and (b.type_id=36 and b.med_id=c.bod_id1 or b.type_id=1 and b.med_id=c.dtl_id)) y on a.bod_id=y.bod_id';
        commandtext:=commandtext+' left join (select b.bod_id,bod_cd2=c.bod_cd,c.qty,b.price,b.amot,carry_dt1=c.carry_dt,c.med_id,c.med_code,c.med_name,c.specifi,c.pdt_place,c.med_unit,c.type_id1 from tb_bill_dtl b,vi_bodstadtlmed c';
        commandtext:=commandtext+'	 where b.bod_id=c.bod_id and (b.type_id=36 and b.med_id=c.bod_id1 or b.type_id=1 and b.med_id=c.rec_id) ) y on a.bod_id=y.bod_id';

//        commandtext:=commandtext+' from tb_bill_dtl b,vi_boddtlmed c where b.bod_id=c.bod_id and (b.type_id=36 and b.med_id=c.med_id or b.type_id=1 and b.med_id=c.dtl_id)) y on a.bod_id=y.bod_id';
...
//    	commandtext:=commandtext+' left join tb_busiframe k on k.rec_id=dbo.fn_getbusiframerecid5(n.district,y.med_id,a.dst_id,y.carry_dt1)';
    	commandtext:=commandtext+' left join tb_busiframe2 k on k.rec_id=dbo.fn_getbusiframerecid2(a.dst_id,a.agent_id,y.med_id,y.carry_dt1)';
        commandtext:=commandtext+' where a.bod_type_id=37 and a.bod_status_id=1';
    	if Trim(dxEdit1.text)='' then
        begin
            if RadioGroup1.ItemIndex=0
...
procedure Tsetreport26a.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetreport26a.N3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetreport26a.N1Click(Sender: TObject);
begin
with dxdbgrid1 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetreport26a.N2Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid1 do
...
procedure Tsetreport26a.N6Click(Sender: TObject);
begin
if FileExists(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini')
    then dxDBGrid1.LoadFromIniFile(extractfilepath(Application.ExeName)+self.name+'-dxDBGrid10.ini');//加载
end;

procedure Tsetreport26a.N7Click(Sender: TObject);
...
procedure Tsetreport26a.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickagent do
...
procedure Tsetreport26a.MenuItem3Click(Sender: TObject);
var
  NewString: string;
  ClickedOK: Boolean;
begin
...
procedure Tsetreport26a.MenuItem5Click(Sender: TObject);
begin
with dxdbgrid2 do Columns[GetAbsoluteColumnIndex(FocusedColumn)].Visible:=false;
end;

procedure Tsetreport26a.MenuItem6Click(Sender: TObject);
var i,mi: integer;
begin
setprogress(1);
with dxdbgrid2 do
...
procedure Tsetreport26a.MenuItem8Click(Sender: TObject);
begin
...
procedure Tsetreport26a.PageControl1Change(Sender: TObject);
begin
if PageControl1.ActivePage=TabSheet1 then wwDBNavigator1.DataSource:=DSqry
    else wwDBNavigator1.DataSource:=DSqry1;
end;

procedure Tsetreport26a.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetreport26a.dxButtonEdit1ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetreport26a.qry1CalcFields(DataSet: TDataSet);
begin
with qry1 do
begin
...
procedure Tsetreport26a.dxDBGrid2CustomDrawCell(Sender: TObject;
...
procedure Tsetreport26a.dxEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
