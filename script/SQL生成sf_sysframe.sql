...
insert into tb_sysframe (sf_parent,sf_title,sf_invoke) values (4,'商业采购入库单',16)
...
insert into tb_sysframe (sf_parent,sf_title,sf_invoke) values (4,'商业进销存报表',21)
...
insert into tb_sysframe (sf_parent,sf_title,sf_invoke) values (8,'新零售流向单',301)
insert into tb_sysframe (sf_parent,sf_title,sf_invoke) values (8,'新零售流向综合查询',302)
/*
