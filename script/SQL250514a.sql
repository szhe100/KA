...
left join tb_staff g on g.sta_type_id=1 and g.zname =a.f8 
...
--select * from tb_staff where sta_type_id=1 and zname=''
select * from @tab
...
inner join @tab k on k.channel_id=a.channel_id and k.channel_dtl_id=a.channel_dtl_id and k.sta_id=a.sta_id and k.mate_id1=a.mate_id1 and k.mate_id=a.mate_id and k.med_id=a.med_id 
	and a.valid_dt=cast(k.f12 as datetime) and rate=cast(f9 as decimal(15,4))
*/
...
from tb_brokermed a 
inner join @tab k on k.channel_id=a.channel_id and k.channel_dtl_id=a.channel_dtl_id and k.sta_id=a.sta_id and k.mate_id1=a.mate_id1 and k.mate_id=a.mate_id and k.med_id=a.med_id
	and a.valid_dt=cast(k.f12 as datetime) and rate1=cast(f11 as decimal(15,4))
...
select distinct comp_id=1,bod_desc=f1,channel_id=a.channel_id,channel_dtl_id=a.channel_dtl_id,a.sta_id,      
mate_id1=a.mate_id1,a.mate_id,a.med_id,price1=cast(f10 as decimal(15,4)),rate1=cast(f11 as decimal(15,4)),valid_dt=cast(f12 as datetime),      
creat_by=19273,creat_dt=getdate() 
from @tab a 
where not exists (select 1 from tb_brokermed k where k.channel_id=a.channel_id and k.channel_dtl_id=a.channel_dtl_id and k.sta_id=a.sta_id and k.mate_id1=a.mate_id1 and k.mate_id=a.mate_id and k.med_id=a.med_id and k.valid_dt=cast(a.f12 as datetime) and k.rate1=cast(a.f11 as decimal(15,4)))

update b set rate=cast(f9 as decimal(15,4)),modify_by=19273,modify_dt=getdate() 
from @tab a  
inner join tb_brokermed k on k.channel_id=a.channel_id and k.channel_dtl_id=a.channel_dtl_id and k.sta_id=a.sta_id and k.mate_id1=a.mate_id1 and k.mate_id=a.mate_id and k.med_id=a.med_id and k.valid_dt=cast(f12 as datetime) and k.rate1=cast(a.f11 as decimal(15,4)) 
...
from @tab a inner join tb_brokermed k on k.channel_id=a.channel_id and k.channel_dtl_id=a.channel_dtl_id and k.sta_id=a.sta_id and k.mate_id1=a.mate_id1 and k.mate_id=a.mate_id and k.med_id=a.med_id and k.valid_dt=cast(f12 as datetime) and k.rate=cast(a.f9 as decimal(15,4))   
...
select rela_id=k.rec_id,sta_id=a.sta_id1,fee_type_id=185,rate=cast(f9 as decimal(15,4)),creat_by=19273,creat_dt=getdate() 
from @tab a inner join tb_brokermed k on k.channel_id=a.channel_id and k.channel_dtl_id=a.channel_dtl_id and k.sta_id=a.sta_id and k.mate_id1=a.mate_id1 and k.mate_id=a.mate_id and k.med_id=a.med_id and k.valid_dt=cast(f12 as datetime) and k.rate1=cast(a.f11 as decimal(15,4))   
where not exists (select 1 from tb_brokermedtl b where k.rec_id=b.rela_id and a.sta_id1=b.sta_id) 
