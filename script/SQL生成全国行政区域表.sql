...
alter table tb_district add level_id tinyint

select * from tb_district where city_code=prov_code+'00'
select * from tb_district where county_code='' and city_code<>prov_code+'00' 
select * from tb_district where county_code<>'' and level_id>0

update tb_district set level_id=1 where city_code=prov_code+'00'
update tb_district set level_id=2 where county_code='' and city_code<>prov_code+'00' 
update tb_district set level_id=3 where county_code<>''

update tb_district set city_name='' where level_id=1

delete from tb_district where rec_id=789

insert into tb_district (country,prov_code,prov_name,city_code,city_name,county_code,county_name,level_id)
select top 1 country,prov_code,prov_name,city_code='1101',city_name,county_code,county_name,level_id=2 from tb_district where rec_id=1
update tb_district set city_name='' where rec_id=1

insert into tb_district (country,prov_code,prov_name,city_code,city_name,county_code,county_name,level_id)
select top 1 country,prov_code,prov_name,city_code='1201',city_name,county_code,county_name,level_id=2 from tb_district where rec_id=18
update tb_district set city_name='' where rec_id=18

insert into tb_district (country,prov_code,prov_name,city_code,city_name,county_code,county_name,level_id)
select top 1 country,prov_code,prov_name,city_code='5001',city_name,county_code,county_name,level_id=2 from tb_district where rec_id=2230
update tb_district set city_name='' where rec_id=2230

insert into tb_district (country,prov_code,prov_name,city_code,city_name,county_code,county_name,level_id)
select top 1 country,prov_code,prov_name,city_code='4690',city_name='省辖县',county_code,county_name,level_id=2 from tb_district where rec_id=2203
