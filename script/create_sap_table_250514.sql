...
select mate_type_id=2,mate_code=partner,mate_name=NAME_ORG1,address=street,tax_code=TAXNUMXL,district=b.rec_id,region=a.region,a.BEZEI,a.CITY1,remark=a.ZCOM
 from SAP_ZSD_Z001 a
...
insert into tb_medprice (type_id,KNUMH,ZCOUNTRY,ZREGIO,ZCITYNUM,district_id,med_id,price,currency,price_unit,valid_from,valid_to)
select type_id=1,KNUMH,ZCOUNTRY,ZREGIO,ZCITYNUM,district=b.rec_id,m.med_id,price=KBETR,currency=KONWA,price_unit=KMEIN,valid_from=DATBI,valid_to=DATAB
 from SAP_ZSD_PR02 a
...
insert into tb_medprice (type_id,KNUMH,ZREGIO,KONDA,channel_id,channel_dtl_id,sale_team_id,cust_group_id,district_id,med_id,price,currency,price_unit,valid_from,valid_to)
select type_id=2,KNUMH,ZREGIO,KONDA,channel_id=c.obj_id,channel_dtl_id=d.obj_id,sale_team_id=f.obj_id,cust_group_id=e.obj_id,district=b.rec_id,m.med_id,price=KBETR,currency=KONWA,price_unit=KMEIN,valid_from=DATBI,valid_to=DATAB
 from SAP_ZSD_PR03 a
