object pickbusimate2: Tpickbusimate2
  Left = 166
  Top = 77
  ...
  AutoScroll = False
  BorderIcons = []
  Caption = #26597#35810#21830#19994#20844#21496
  ClientHeight = 506
  ClientWidth = 1005
  Color = clBtnFace
  ...
  object DBGrid1: TdxDBGrid
    ...
    object DBGrid1zname1: TdxDBGridMaskColumn
      Font.Charset = GB2312_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = #23435#20307
    ...
    object DBGrid1address1: TdxDBGridColumn
      Width = 90
      BandIndex = 0
      RowIndex = 0
      FieldName = 'address1'
    end
    object DBGrid1phone1: TdxDBGridColumn
      Width = 70
      BandIndex = 0
      RowIndex = 0
      FieldName = 'phone1'
    end
    object DBGrid1zname2: TdxDBGridColumn
      Width = 50
      BandIndex = 0
      RowIndex = 0
      FieldName = 'zname2'
    end
    object DBGrid1address2: TdxDBGridColumn
      Width = 90
      BandIndex = 0
      RowIndex = 0
      FieldName = 'address2'
    end
    object DBGrid1phone2: TdxDBGridColumn
      Width = 70
      BandIndex = 0
      RowIndex = 0
      FieldName = 'phone2'
  ...
  object query1: TClientDataSet
    ...
    object query1zname1: TStringField
      DisplayLabel = #25910#36135#20154
      FieldName = 'zname1'
      Size = 50
    end
    object query1address1: TStringField
      DisplayLabel = #22320#22336
      FieldName = 'address1'
      Size = 100
    end
    object query1phone1: TStringField
      DisplayLabel = #30005#35805
      FieldName = 'phone1'
      Size = 50
    end
    object query1zname2: TStringField
      DisplayLabel = #25910#31080#20154
      FieldName = 'zname2'
      Size = 50
    end
    object query1address2: TStringField
      DisplayLabel = #22320#22336
      FieldName = 'address2'
      Size = 100
    end
    object query1phone2: TStringField
      DisplayLabel = #30005#35805
      FieldName = 'phone2'
      Size = 50
    end
