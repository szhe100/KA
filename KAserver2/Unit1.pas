...
//    pubcom.ConnectionString:='Provider=SQLOLEDB.1;Persist Security Info=False;User ID=easyway;Password=easyway190304;Initial Catalog='+str2+';Data Source='+str1;
    pubcom.ConnectionString:='Provider=SQLOLEDB.1;Password=easyway190304;Persist Security Info=True;User ID=easyway;Initial Catalog='+str2+';Data Source='+str1;
//Data Source=localhost;Initial Catalog=KingageYPH;Persist Security Info=True;User ID=easyway
//    pubcom.ConnectionString:='Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog='+str2+';Data Source='+str1;
//    pubcom.ConnectionString:='Data Source='+str1+';Initial Catalog='+str2+';Integrated Security=True';
//InputBox('输入窗口标题', '输入提示', pubcom.ConnectionString);
//    pubcom.ConnectionString:='Data Source=localhost;Initial Catalog=KingageYPH;Integrated Security=True';
//    pubcom.ConnectionString:='Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=KingageYPH;Data Source=KA-SQL02\KASLAVE
