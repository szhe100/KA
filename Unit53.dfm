object setruleapply: Tsetruleapply
  Left = 191
  Top = 106
  AutoScroll = False
  Caption = #36153#29992#35268#21017#19994#21153#30003#35831
  ClientHeight = 457
  ClientWidth = 864
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object dxDBGrid3: TdxDBGrid
          ...
          object dxDBGrid3Lfee_type: TdxDBGridLookupColumn
            Alignment = taCenter
            DisableEditor = True
            Width = 69
            BandIndex = 0
        ...
        object dxDBGrid2: TdxDBGrid
          ...
          object dxDBGrid2mate_name: TdxDBGridButtonColumn
            DisableEditor = True
            Font.Charset = GB2312_CHARSET
            Font.Color = clNavy
            Font.Height = -12
            ...
            OnButtonClick = dxDBGrid2mate_nameButtonClick
          end
  ...
  object cdsbill: TClientDataSet
    ...
    object cdsbillleader: TStringField
    ...
    object cdsbillmed_code: TStringField
      DisplayLabel = #33647#21697#32534#30721
      FieldName = 'med_code'
    end
    object cdsbillmaterial_code: TStringField
    ...
    object cdsbillspecifi: TStringField
      DisplayLabel = #35268#26684
      FieldName = 'specifi'
      Size = 50
    end
    object cdsbillpdt_place: TStringField
  ...
  object cdsbill_dtl: TClientDataSet
    ...
    object cdsbill_dtltrusted: TBooleanField
    ...
    object cdsbill_dtlbod_desc: TStringField
      DisplayLabel = #30003#35831#25688#35201
      FieldName = 'bod_desc'
      Size = 100
    end
    ...
    object cdsbill_dtlCrate: TFloatField
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select top 1 *,receiver=dbo.fn_staff_name(creat_by) from tb_bill')
    Left = 514
    Top = 211
    object ADOQuery1bod_id: TAutoIncField
      FieldName = 'bod_id'
      ReadOnly = True
    end
    ...
    object ADOQuery1src_id: TIntegerField
      FieldName = 'src_id'
    end
    object ADOQuery1dst_id: TIntegerField
      FieldName = 'dst_id'
    end
    object ADOQuery1bod_status_id: TIntegerField
      FieldName = 'bod_status_id'
    end
    object ADOQuery1bod_type_id: TIntegerField
      FieldName = 'bod_type_id'
    end
    object ADOQuery1busi_type: TIntegerField
      FieldName = 'busi_type'
    end
    ...
    object ADOQuery1carry_by: TIntegerField
      FieldName = 'carry_by'
    end
    object ADOQuery1carry_dt: TDateTimeField
      FieldName = 'carry_dt'
    end
    object ADOQuery1check_by: TIntegerField
      FieldName = 'check_by'
    end
    object ADOQuery1check_dt: TDateTimeField
      FieldName = 'check_dt'
    end
    object ADOQuery1delete_by: TIntegerField
      FieldName = 'delete_by'
    end
    object ADOQuery1delete_dt: TDateTimeField
      FieldName = 'delete_dt'
    end
    object ADOQuery1receipt_by: TIntegerField
      FieldName = 'receipt_by'
    end
    object ADOQuery1receipt_dt: TDateTimeField
      FieldName = 'receipt_dt'
    end
    ...
    object ADOQuery1relative_id: TIntegerField
      FieldName = 'relative_id'
    end
    object ADOQuery1prncount: TIntegerField
      FieldName = 'prncount'
    end
    object ADOQuery1settle_type: TIntegerField
      FieldName = 'settle_type'
    end
    object ADOQuery1allo_desc: TStringField
      FieldName = 'allo_desc'
    end
    ...
    object ADOQuery1receiver: TStringField
      FieldName = 'receiver'
      ReadOnly = True
      Size = 100
    end
  ...
  object brokermedtl: TClientDataSet
    ...
    object brokermedtlfee_type: TStringField
