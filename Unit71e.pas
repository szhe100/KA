...
type
  Tsetbrokerfeeoffset = class(TForm)
...
var
  setbrokerfeeoffset: Tsetbrokerfeeoffset;
...
procedure Tsetbrokerfeeoffset.setupdatestatus;    // 编辑状态
begin
...
procedure Tsetbrokerfeeoffset.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsetbrokerfeeoffset.FormActivate(Sender: TObject);
begin
with dm.district do
...
procedure Tsetbrokerfeeoffset.FormCloseQuery(Sender: TObject;
...
procedure Tsetbrokerfeeoffset.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsetbrokerfeeoffset.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbrokerfeeoffset.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsetbrokerfeeoffset.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsetbrokerfeeoffset.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsetbrokerfeeoffset.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' ,bod_cd1=dbo.fn_getbodcd1(a.bod_id),a.channel_id,channel=dbo.fn_obj_desc(a.channel_id),a.channel_dtl_id,channel_dtl=dbo.fn_obj_desc(a.channel_dtl_id)';
    ...
    commandtext:=commandtext+' where a.bod_type_id=57'; // a.comp_id='+inttostr(compid)+' and
...
procedure Tsetbrokerfeeoffset.FormCreate(Sender: TObject);
begin
...
procedure Tsetbrokerfeeoffset.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsetbrokerfeeoffset.DSbillDataChange(Sender: TObject; Field: TField);
begin
    ...
    with cdsbill_dtl do
        if tag<>cdsbill.fieldbyname('bod_id').asinteger then
            ...
            begin
                ...
                commandtext:=commandtext+' d.bat_cd,e.price1,d.price3,med_code,m.material_code,med_name,chm_name,specifi,pdt_place,med_unit=dbo.fn_obj_desc(m.unit_id),med_type=dbo.fn_med_type(m.med_id),e.type_id2';
...
//                commandtext:=commandtext+' left join tb_brokermed o on o.rec_id=dbo.fn_ruleid (d.sta_id,c.dst_id,d.med_id,c.carry_dt)';
                commandtext:=commandtext+' left join (select i.rec_id,i.type_id2,i.price1,j.sta_id,j.rate from tb_brokermed i inner join tb_brokermedtl j on i.rec_id=j.rela_id) e';
                commandtext:=commandtext+'  on e.rec_id =dbo.fn_getbrokermedrecid(c.src_id,c.dst_id,d.med_id,c.carry_dt) and e.sta_id=h.sta_id'; //b.rule_id=d.rec_id';
...
procedure Tsetbrokerfeeoffset.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokerfeeoffset.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokerfeeoffset.SpeedButton2Click(Sender: TObject);
var s: string;
begin
...
procedure Tsetbrokerfeeoffset.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsetbrokerfeeoffset.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsetbrokerfeeoffset.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsetbrokerfeeoffset.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
...
procedure Tsetbrokerfeeoffset.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsetbrokerfeeoffset.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsetbrokerfeeoffset.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsetbrokerfeeoffset.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsetbrokerfeeoffset.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsetbrokerfeeoffset.N1Click(Sender: TObject);
...
procedure Tsetbrokerfeeoffset.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure Tsetbrokerfeeoffset.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsetbrokerfeeoffset.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetbrokerfeeoffset.cdsbill_dtl1AfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl1.ChangeCount>0 then myupdaterefresh(cdsbill_dtl1,'tb_bill_dtl','dtl_id','');
end;

procedure Tsetbrokerfeeoffset.N3Click(Sender: TObject);
var mi,j,k,l,i : integer;
    s,t : string;
begin
if (cdsbill.active=false) or (cdsbill.recordcount=0) then exit;
...
procedure Tsetbrokerfeeoffset.dxEdit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tsetbrokerfeeoffset.dxLookupTreeView1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key=vk_delete then dxLookupTreeView1.text:='';
end;

procedure Tsetbrokerfeeoffset.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsetbrokerfeeoffset.cdsbill_dtl1CalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl1 do
begin
    case fieldbyname('type_id2').asinteger of  //1已办个户、2不办个户、3已办个户不交资料、4不办个户不交资料
...
procedure Tsetbrokerfeeoffset.DSbill_dtl1StateChange(Sender: TObject);
begin
with cdsbill_dtl1 do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsetbrokerfeeoffset.dxButtonEdit4ButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
with pickbroker do
    if showmodal= mrOK then
...
procedure Tsetbrokerfeeoffset.Excel1Click(Sender: TObject);
begin
