...
type
  Tsettrustruleapply = class(TForm)
...
var
  settrustruleapply: Tsettrustruleapply;
//  ptype: string[20];
//  pcent: real;
...
procedure Tsettrustruleapply.setupdatestatus;    // 编辑状态
begin
...
procedure Tsettrustruleapply.setunupdatestatus;  // 浏览状态
begin
...
procedure Tsettrustruleapply.FormActivate(Sender: TObject);
begin
{
with dm.fee_type do
...
procedure Tsettrustruleapply.FormCloseQuery(Sender: TObject;
...
procedure Tsettrustruleapply.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure Tsettrustruleapply.dxDBGrid1DblClick(Sender: TObject);
begin
pagecontrol1.activepage:=tabsheet2;
DSbillDataChange(PageControl1,nil);
end;

procedure Tsettrustruleapply.DSbill_dtlDataChange(Sender: TObject;
  Field: TField);
begin
with cdsbill_dtl do
...
procedure Tsettrustruleapply.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tsettrustruleapply.SpeedButton8Click(Sender: TObject);
var mid: integer;
begin
...
procedure Tsettrustruleapply.SpeedButton9Click(Sender: TObject);
begin
// cancel speedbutton
...
procedure Tsettrustruleapply.SpeedButton5Click(Sender: TObject);
var bi: integer;
begin
// refresh speedbutton
...
begin
    ...
    commandtext:=commandtext+' where a.bod_type_id=24'; // a.comp_id='+inttostr(compid)+' and
...
procedure Tsettrustruleapply.FormCreate(Sender: TObject);
begin
...
procedure Tsettrustruleapply.SpeedButton7Click(Sender: TObject);
begin
...
procedure Tsettrustruleapply.DSbillDataChange(Sender: TObject; Field: TField);
begin
...
procedure Tsettrustruleapply.DSbillStateChange(Sender: TObject);
begin
with cdsbill do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsettrustruleapply.DSbill_dtlStateChange(Sender: TObject);
begin
with cdsbill_dtl do
    if state in [dsinsert,dsedit] then setupdatestatus;
end;

procedure Tsettrustruleapply.SpeedButton2Click(Sender: TObject);
var s: string;
begin
{
with cdsbill do
...
procedure Tsettrustruleapply.cdsbillBeforeEdit(DataSet: TDataSet);
begin
with cdsbill do
begin
...
procedure Tsettrustruleapply.cdsbillCalcFields(DataSet: TDataSet);
begin
with cdsbill do
...
procedure Tsettrustruleapply.cdsbill_dtlBeforeDelete(DataSet: TDataSet);
begin
cdsbillBeforeEdit(nil);
if MessageBox(0,'确定删除本记录','请注意',MB_YESNO+MB_ICONQUESTION)<>IDYES then abort;
end;

procedure Tsettrustruleapply.cdsbill_dtlBeforeEdit(DataSet: TDataSet);
begin
if cdsbill.fieldbyname('bod_status_id').asinteger=1
...
procedure Tsettrustruleapply.cdsbill_dtlReconcileError(DataSet: TClientDataSet;
  E: EReconcileError; UpdateKind: TUpdateKind;
  var Action: TReconcileAction);
begin
...
procedure Tsettrustruleapply.cdsbill_dtlAfterInsert(DataSet: TDataSet);
begin
with cdsbill_dtl do
    fieldbyname('bod_id').asinteger:=cdsbill.fieldbyname('bod_id').asinteger;
end;

procedure Tsettrustruleapply.cdsbill_dtlpriceChange(Sender: TField);
begin
with cdsbill_dtl do
...
procedure Tsettrustruleapply.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.activepage=TabSheet2 then DSbillDataChange(PageControl1,nil);
end;

procedure Tsettrustruleapply.dxDBGrid1CustomDrawCell(Sender: TObject;
...
procedure Tsettrustruleapply.N1Click(Sender: TObject);
...
procedure Tsettrustruleapply.cdsbill_dtlAfterPost(DataSet: TDataSet);
begin
if cdsbill_dtl.ChangeCount>0 then myupdaterefresh(cdsbill_dtl,'tb_bill_dtl','dtl_id','');
end;

procedure Tsettrustruleapply.dxDBGrid2mate_nameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure Tsettrustruleapply.cdsbill_dtlCalcFields(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
...
procedure Tsettrustruleapply.brokermedtlCalcFields(DataSet: TDataSet);
begin
with brokermedtl do
begin
...
procedure Tsettrustruleapply.cdsbill_dtlBeforePost(DataSet: TDataSet);
begin
with cdsbill_dtl do
begin
